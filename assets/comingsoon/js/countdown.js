...
function countdown() {
    ...
    var launch_date = new Date(Date.UTC(2018, 2, 19, 0, 0));
    var days;
    var hours;
    var minutes;
    var seconds;
    ...
    ctd.innerHTML =
        '<li><div><span>' + days + '</span><br> Jour' + (days > 1 ? '(s)' : '') + '</div></li>' +
        '<li><div><span>' + hours + '</span><br> heure' + (hours > 1 ? '(s)' : '') + '</div></li>' +
        '<li><div><span>' + minutes + '</span><br> minute' + (minutes > 1 ? '(s)' : '') + '</div></li>' +
        '<li><div><span>' + seconds + '</span><br> seconde' + (seconds > 1 ? '(s)' : '') + '</div></li>';
}

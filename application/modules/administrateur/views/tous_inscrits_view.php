...
<head>
    <title>ISTjob tous les candidats</title>
    <meta charset="utf-8">
                    ...
                    <div class="content-box">
                        <div class="element-wrapper">
                            ...
                            <div class="element-box">
                                <h5 class="form-header">Tous les personnes inscrits sur Istjob</h5>
                                ...
                                <div class="element-wrapper">
                                    <div class="element-box">
                                        <form id="formValidate">
                                            <h5 class="form-header">Tous les personnes inscrites</h5>
                                    ...
                                    <tbody>
                                              <?php
                                               ...
                                               if(isset($tous_inscrits)){ 

                                               $compt=0;

                                                 foreach($tous_inscrits as $tcan){
                                               ...
                                               <tr>
                                                    ...
                                                    <td ><?php echo $tcan->nom_candidat;  ?> </td>
                                                    <td ><?php echo $tcan->prenoms_candidat;  ?> </td>
                                                    
                                                    <td ><?php echo $tcan->email_candidat;  ?> </td>

                                                    <td ><?php echo $tcan->telephone_mobil1;  ?> </td>

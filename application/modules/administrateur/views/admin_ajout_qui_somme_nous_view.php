...
<head>
    <title>ISTJOB Qui sommes  nous</title>
    <meta charset="utf-8">
                    ...
                    <div class="content-box">
                        <div class="element-wrapper">
                            ...
                            <div class="element-box">
                                <h5 class="form-header">Qui est ISTJOB ?</h5>
                                    ...
                                    <div class="element-box">
                                        <span id="formValidate">
                                            ...
                                            <div class="element-wrapper">
                                                 ...
                                                 if(isset($quiSommeNous)){

                                                   foreach($quiSommeNous as $info){ ?>

                           
                                                    <div class="element-box">
                                                       
                                                        <form action="<?php echo base_url('administrateur/uploadPhotoQuiSommesNous');?>" class="dropzone" id="my-awesome-dropzone" method="POST">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                    <?php echo form_open('administrateur/quiSommeNous'); ?>

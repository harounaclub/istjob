...
<head>
    <title>ISTJOB ajouter un temoignage</title>
    <meta charset="utf-8">
                    ...
                    <div class="content-box">
                        <div class="element-wrapper">
                            ...
                            <div class="element-box">
                                <h5 class="form-header"> Ajouter un temoignage</h5>
...
------------------  -->
                                ...
                                <div class="element-wrapper">
                                    <div class="element-box">
                                        <span id="formValidate">
                                            ...
                                            <div class="element-wrapper">
                                                    ...
                                                    <div class="element-box">
                                                        ...
                                                        <form action="<?php echo base_url('administrateur/uploadPhotoTemoignages');?>" class="dropzone" id="my-awesome-dropzone" method="POST">
                                                            <input class="form-control" type="hidden" name="id_temoignage" value="<?php echo $id_temoignage; ?>">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                    <?php echo form_open('administrateur/ajoutTemoignage'); ?>
                                     <input class="form-control" type="hidden" name="id_temoignage" value="<?php echo $id_temoignage; ?>">
                                            ...
                                            <div class="form-group">
                                                <label for="">Nom et prenom (s)</label>
 <input class="form-control"  placeholder="entrer le nom et le prenom" required="required" type="text" name="nom_prenom" value="">
                                <?php echo form_error('nom_prenom','<font color="red">','</font>'); ?>
 ...
 <input class="form-control"  placeholder="entrer le titre " required="required" type="text" name="titre" value="">
                                <?php echo form_error('titre','<font color="red">','</font>'); ?>

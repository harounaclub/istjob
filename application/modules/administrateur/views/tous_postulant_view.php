...
<head>
    <title>ISTjob Tous les  postulants</title>
    <meta charset="utf-8">
                    ...
                    <div class="content-box">
                        <div class="element-wrapper">
                            ...
                            <div class="element-box">
                                <h5 class="form-header">Tous les  postulants</h5>
                            ...
                            <div class="col-sm-12">
                                <div class="element-wrapper">
                                    ...
                                    <tbody>
                                               ...
                                               if(isset($tous_les_postulants)){ 

                                               $compt=0;

                                                foreach($tous_les_postulants as $tcan){
                                               ...
                                               <tr>
                                                    ...
                                                    <td>
                                                      ...
                                                      <?php
                                                       ...
                                                       <a href="<?php echo base_url(); ?>administrateur/selectionner_candidat/<?php echo $id_candidat; ?>/<?php echo $id_offre; ?>" class="btn btn-success"><div><i class="fa fa-twitter"></i></div>Sélectionner </a>


                                                     <?php
                                                       }else{ ?>

                                                       <a href="<?php echo base_url(); ?>administrateur/deselectionner_candidat/<?php echo $id_candidat; ?>/<?php echo $id_offre; ?>" class="btn btn-danger"><div><i class="fa fa-twitter"></i></div>desélectioner </a>

...
<head>
    <title>Istjobs ajouter nous contacter</title>
    <meta charset="utf-8">
                    ...
                    <div class="content-box">
                        <div class="element-wrapper">
                            ...
                            <div class="element-box">
                                <h5 class="form-header"> Ajouter nous contacter</h5>
...
------------------  -->
                                ...
                                <div class="element-wrapper">
                                    <div class="element-box">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                    <?php echo form_open('administrateur/ajoutContacterNous'); ?>
                                     <input class="form-control" type="hidden" name="id_contacter_nous" value="<?php echo $id_contacter_nous; ?>">
                                            ...
                                            <div class="form-group">
                                                <label for="">Nom</label>
 <input class="form-control"  placeholder="entrer le nom " required="required" type="text" name="nom" value="">
 ...
 <input class="form-control"  placeholder="entrer le prenom " required="required" type="text" name="prenoms" value="">
                                <?php echo form_error('prenoms','<font color="red">','</font>'); ?>
                                            ...
                                            <div class="form-group">
                                                <label for="">Foction</label>
 <input class="form-control"  placeholder="entrer le foction " required="required" type="text" name="fonction" value="">
                                <?php echo form_error('fonction','<font color="red">','</font>'); ?>
 ...
 <input class="form-control"  placeholder="entrer email " required="required" type="text" name="email" value="">

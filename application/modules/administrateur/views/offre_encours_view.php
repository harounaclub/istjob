...
<head>
    <title>ISTjob Offres en cours ...</title>
    <meta charset="utf-8">
                ...
                <div class="content-i">
                    <div class="content-box">
                        <div class="element-wrapper">
                            <h6 class="element-header">Listes de toutes les offres en cours ...</h6>
                            <div class="element-box">
                                <h5 class="form-header">Listes de toutes les offres en cours ...</h5>
                                <div class="form-desc">Cette page affiche la liste de toutes les offres d'emplois en cours ... </div>
                                                ...
                                                <?php
                                                  ...
                                                  if(isset($liste_offres_emplois)){ 
                                                    ...
                                                    <td class="row-actions">
                                                         <a href="<?php echo base_url(); ?>administrateur/modifier_offre/<?php echo $id_offre; ?>" class="mr-2 mb-2 btn btn-primary" style="color: white;">Modifier</a>

                    ...
                    <div class="content-box">
                        <div class="element-wrapper">
                            ...
                            <div class="element-box">
                                <h5 class="form-header">Tous les contacters</h5>
                                <div class="form-desc"></div>
                                 <a href="<?php echo base_url(); ?>administrateur/ajoutContacterNous" class="mr-2 mb-2 btn btn-primary" style="color: white;">Ajouter contacter</a>
...
------------------  -->
                            ...
                            <div class="col-sm-12">
                                <div class="element-wrapper">
                                    ...
                                    <tbody>
                                        <?php
                                    if(isset($liste_contacter)){
                                        $compt=0;
                                        foreach ($liste_contacter as $cli) { 
                                          $compt=$compt+1;

                                          $id_contacter_nous=$cli->id_contacter_nous;
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $cli->prenoms; ?></td>
                                             <td><?php echo $cli->fonction; ?></td>
                                              <td><?php echo $cli->email; ?></td>
                                            <td>
                                                
                                                <a href="<?php echo base_url(); ?>administrateur/suppression_client/<?php echo $id_contacter_nous; ?>" class="mr-2 mb-2 btn btn-danger" style="color: white;">supprimer</a>
                                            </td>

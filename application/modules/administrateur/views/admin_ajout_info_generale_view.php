...
<head>
    <title>ISTJOB Informations générales</title>
    <meta charset="utf-8">
...
------------------  -->
                            ...
                            <div class="col-sm-6">
                                <div class="element-wrapper">
                                        ...
                                        <span id="formValidate">
                                            ...
                                            <div class="element-wrapper">
                                                    ...
                                                    <div class="element-box">
                                                        ...
                                                        <form action="<?php echo base_url('administrateur/uploadPhotoInfoGeneral');?>" class="dropzone" id="my-awesome-dropzone" method="POST">

                                                            <input class="form-control" type="hidden" name="id_infos_generales" value="<?php echo $id_infos_generales; ?>">

                                                            
                                                            <div class="dz-message">
                                                                <div>
                                                                    <h4>Glisser et deposer le logo (172 x 50 px).</h4>
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <br><br><br><br><br><br>
                                        <img src="<?php echo base_url(); ?>uploads/logo/<?php echo $info->logo; ?>" width="172px" height="50px">

                                    </div>
                                    </div>
                                         <?php echo form_open('administrateur/informationGenerale'); ?>   
                                         <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control"  placeholder="entrer le pays " required="required" type="text" name="pays" value="<?php echo $info->pays; ?>">
                                <?php echo form_error('pays','<font color="red">','</font>'); ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control"  placeholder="entrer la ville" required="required" type="text" name="ville" value="<?php echo $info->ville; ?>" >
                                <?php echo form_error('ville','<font color="red">','</font>'); ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control"  placeholder="entrer la commune" required="required" type="text" name="commune" value="<?php echo $info->commune; ?>">
                                <?php echo form_error('commune','<font color="red">','</font>'); ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control"  placeholder="entrer le quartier" required="required" type="text" name="quartier" value="<?php echo $info->quartier; ?>" >
                                <?php echo form_error('quartier','<font color="red">','</font>'); ?>
                                            ...
                                            <div class="form-group">
                                                <label for="">Immeuble / Etage</label>
                                                <input class="form-control"  placeholder="entrer  l'étage" required="required" type="text" name="immeuble" value="<?php echo $info->immeuble; ?>">
                                <?php echo form_error('immeuble','<font color="red">','</font>'); ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control"  placeholder="entrer le site internet" required="required" type="text" name="site_internet" value="<?php echo $info->site_internet; ?>" >
                                <?php echo form_error('site_internet','<font color="red">','</font>'); ?>
                                            ...
                                            <div class="form-group">
                                                <label for="">Téléphone(s)</label>
                                                <input class="form-control"  placeholder="Entrer le ou les  téléphone(s)" required="required" type="text" name="telephone" value="<?php echo $info->telephone; ?>" >
                                <?php echo form_error('telephone','<font color="red">','</font>'); ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control"  placeholder="facebook"  type="text" name="facebook" value="<?php echo $info->facebook; ?>"  >
                                <?php echo form_error('facebook ','<font color="red">','</font>'); ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control"  placeholder="youtube" type="text" name="youtube" value="<?php echo $info->youtube; ?>"  >
                                <?php echo form_error('youtube','<font color="red">','</font>'); ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control"  placeholder="twitter" type="text" name="twitter" value="<?php echo $info->twitter; ?>" >
                                <?php echo form_error('twitter','<font color="red">','</font>'); ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control"  placeholder="Google +" type="text" name="google_plus" value="<?php echo $info->google_plus; ?>" >
                                <?php echo form_error('google_plus','<font color="red">','</font>'); ?>
                                            ...
                                            <div class="form-group">
                                                <label for="">Lindin</label>
                                                <input class="form-control"  placeholder="lindin" type="text" name="lindin" value="<?php echo $info->lindin; ?>" >
                                <?php echo form_error('lindin','<font color="red">','</font>'); ?>
                    ...
                    <textarea class="form-control" rows="3"  name="apropos">

                        <?php echo $info->apropos; ?>
                           
                                                    </textarea>
                                                     <?php echo form_error('apropos','<font color="red">','</font>'); ?>
                                                </div>
                                                 </div>

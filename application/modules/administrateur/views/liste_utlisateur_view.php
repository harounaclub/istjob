...
<head>
    <title>ISTjob tous les utilisateurs</title>
    <meta charset="utf-8">
                    ...
                    <div class="content-box">
                        <div class="element-wrapper">
                            ...
                            <div class="element-box">
                                <h5 class="form-header">Tous les utilisateurs</h5>
                                <div class="form-desc"></div>
                                <a href="<?php echo base_url(); ?>administrateur/ajout_utlisateur" class="mr-2 mb-2 btn btn-primary" style="color: white;">Ajouter un utilisateur</a>
...
------------------  -->
                            ...
                            <div class="col-sm-12">
                                <div class="element-wrapper">
                                    ...
                                    <tbody>
                                       <?php
                                    if(isset($liste_utlisateur)){
                                        $compt=0;
                                        foreach ($liste_utlisateur as $lisu) { 
                                          $compt=$compt+1;
                                          $id_administrateur=$lisu->id_administrateur;
                                          $id_profil=$lisu->id_profil;

                                        ?>

                                        <tr>
                                            <td><?php echo $compt; ?></td>
                                            <td><?php echo $lisu->nom_administrateur; ?></td>
                                            <td><?php echo $lisu->prenoms_administrateur; ?></td>
                                            <td><?php echo $this->administrateur_model->get_liste_profil_nom($id_profil); ?></td>
                                            <td><?php echo $lisu->login_administrateur; ?></td>
                                            <td><?php echo $lisu->mdp_administrateur; ?></td>
                                            <td><?php echo $lisu->telephone_administrateur; ?></td>
                                            <td>
                                                <a href="" class="mr-2 mb-2 btn btn-primary" style="color: white;">Modifier</a>
                                                <a href="<?php echo base_url(); ?>administrateur/suppression_utilisateur/<?php echo $id_administrateur; ?>" class="mr-2 mb-2 btn btn-danger" style="color: white;">supprimer</a>
                                            </td>

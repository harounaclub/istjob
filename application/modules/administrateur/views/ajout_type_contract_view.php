...
<head>
    <title>ISTjob Ajouter un type de contract</title>
    <meta charset="utf-8">
                    ...
                    <div class="content-box">
                        <div class="element-wrapper">
                            ...
                            <div class="element-box">
                                <h5 class="form-header">Ajouter un type de contrat</h5>
                                <div class="form-desc"></div>
                                <a href="<?php echo base_url(); ?>administrateur/liste_type_contract" class="mr-2 mb-2 btn btn-primary" style="color: white;">Liste des types de contrat</a>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" id="libelletypecontrat" type="text">
...
-------------------->
    ...
    <script>
      ...
      $( "#btn_ajouter" ).click(function(e) {
                    ...
                    var libelletypecontrat=$( "#libelletypecontrat" ).val();
                ...
                $.ajax({
                                           ...
                                           type: 'POST',
                                           url: '<?php echo base_url(); ?>administrateur/ajax_ajout_typecontrat',
                                           dataType:'json',
                                           data: {
                                           ...
                                           success: function(response) {
                                              ...
                                              if(reponse == "1"){
                                                ...
                                                alert("type de contrat enregistre avec succes");

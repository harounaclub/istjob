...
<head>
    <title>ISTJOB Que faisons  nous</title>
    <meta charset="utf-8">
                    ...
                    <div class="content-box">
                        <div class="element-wrapper">
                            ...
                            <div class="element-box">
                                <h5 class="form-header">Que faisons  nous</h5>
                                    ...
                                    <div class="element-box">
                                        <span id="formValidate">
                                            ...
                                            <div class="element-wrapper">
                                                 ...
                                                 if(isset($queFaisonsNous)){

                                                   foreach($queFaisonsNous as $info){  ?>
                           
                                                    <div class="element-box">
                                                       
                                                        <form action="<?php echo base_url('administrateur/uploadPhotoQueFaisonNous');?>" class="dropzone" id="my-awesome-dropzone" method="POST">
                                                            <input class="form-control" type="hidden" name="id_pages" value="<?php echo $id_pages; ?>">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                    <?php echo form_open('administrateur/queFaisonsNous'); ?>
                                     <input class="form-control" type="hidden" name="id_pages" value="">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control"  placeholder="entrer le titre " required="required" type="text" name="titre" value="<?php echo $info->titre; ?>">

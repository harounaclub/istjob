...
<head>
    <title>ISTjob toutes les offres postée</title>
    <meta charset="utf-8">
                ...
                <div class="content-i">
                    <div class="content-box">
                        <div class="element-wrapper">
                            <h6 class="element-header">Listes de toutes les offres postée</h6>
                            <div class="element-box">
                                <h5 class="form-header">Listes de toutes les offres postée</h5>
                                <div class="form-desc">Cette page affiche la liste de toutes les offres d'emplois enregistrées sur la plateforme tout status confondus </div>
                                            ...
                                            <tbody>
                                                ...
                                                <?php
                                                  ...
                                                  if(isset($liste_offres_emplois)){ 
                                                    ...
                                                    foreach ($liste_offres_emplois as $valeur) {

                                                        $compt=$compt+1;
                                                        $id_offre=$valeur->id_offre;
                                                        $status=$valeur->status_offre;

                                                        
                                                        $id_entreprise=$valeur->id_entreprise;
                                                        $entreprise=$this->administrateur_model->get_nom_entreprise($id_entreprise);
                                                    ?>

                                                    <tr>
                                                    <td > <?php echo $compt;?> </td>
                                                    <td> <?php echo $valeur->libelle_offre;?> </td>
                                                    <td><?php echo $entreprise;?></td>
                                                    <td class="text-right"><?php echo $valeur->date_debut_offre;?></td>
                                                    <td><?php echo $valeur->date_fin_offre;?></td>
                                                    ...
                                                    <td class="row-actions">
                                                         <a href="<?php echo base_url(); ?>administrateur/details_offre/<?php echo $id_offre; ?>" class="mr-2 mb-2 btn btn-primary" style="color: white;">Plus info</a>

                                                    <?php 
                                                       if($status == 0){ ?>

                                                       <a href="<?php echo base_url(); ?>administrateur/publ_depubl_offre/<?php echo $id_offre; ?>/1" class="mr-2 mb-2 btn btn-success" style="color: white;">De publier</a>

                                                       <?php }else{ ?>

                                                       <a href="<?php echo base_url(); ?>administrateur/publ_depubl_offre/<?php echo $id_offre; ?>/0" class="mr-2 mb-2 btn btn-danger" style="color: white;">Publier</a>

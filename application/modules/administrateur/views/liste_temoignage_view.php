...
<head>
    <title>ISTjob tous les temoignages</title>
    <meta charset="utf-8">
                    ...
                    <div class="content-box">
                        <div class="element-wrapper">
                            ...
                            <div class="element-box">
                                <h5 class="form-header">Tous les temoignages</h5>
                                <div class="form-desc"></div>
                                 <a href="<?php echo base_url(); ?>administrateur/ajoutTemoignage" class="mr-2 mb-2 btn btn-primary" style="color: white;">Ajouter un temoignages</a>
...
------------------  -->
                            ...
                            <div class="col-sm-12">
                                <div class="element-wrapper">
                                    ...
                                    <tbody>
                                        <?php
                                    if(isset($liste_temoignages)){
                                        $compt=0;
                                        foreach ($liste_temoignages as $cli) { 
                                          $compt=$compt+1;

                                          $id_temoignage=$cli->id_temoignage;

                                        ?>

                                        <tr>
                                            <td><?php echo $compt; ?></td>
                                            <td><?php echo $cli->nom_prenom; ?></td>
                                            <td><?php echo $cli->titre; ?></td>
                                             <td><?php echo $cli->commentaire; ?></td>
                                              
                                            <td>
                                               
                                                <a href="<?php echo base_url(); ?>administrateur/suppression_client/<?php echo $id_temoignage; ?>" class="mr-2 mb-2 btn btn-danger" style="color: white;">supprimer</a>
                                            </td>

                                ...
                                <div class="element-wrapper">
                                    ...
                                    <div class="element-content">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-4">
                                                <a class="element-box el-tablo" href="<?php echo base_url(); ?>administrateur/liste_candidats">
                                        ...
                                        <div class="value"><?php echo $nb_candidat; ?></div>
                                            ...
                                            <div class="col-sm-4">
                                                <a class="element-box el-tablo" href="<?php echo base_url(); ?>administrateur/toutes_offres">
                                            ...
                                            <div class="col-sm-4">
                                                <a class="element-box el-tablo" href="<?php echo base_url(); ?>administrateur/liste_client">
                                                ...
                                                <tbody>
                                                  ...
                                                  if(isset($liste_offre_stat)){ 
                                                     ...
                                                     foreach ($liste_offre_stat as  $value){
                                                        ...
                                                        $libelle_offre =$value->libelle_offre ;

                                                        $taille_intitule=strlen($libelle_offre);


                                                        if($taille_intitule > 38){

                                                          $intitule_offre_reduit=substr($libelle_offre , 0,38)."...";  


                                                        }else{

                                                            $intitule_offre_reduit=$libelle_offre;

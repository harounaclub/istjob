...
<head>
    <title>ISTjob Ajouter un client</title>
    <meta charset="utf-8">
                    ...
                    <div class="content-box">
                        <div class="element-wrapper">
                            ...
                            <div class="element-box">
                                <h5 class="form-header">Ajouter un client</h5>
                                <div class="form-desc"></div>
                                <a href="<?php echo base_url(); ?>administrateur/liste_client" class="mr-2 mb-2 btn btn-primary" style="color: white;">Liste des clients</a>
                                    ...
                                    <div class="element-box">
                                        <span id="formValidate">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" id="rccm" type="text">
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" id="email_entreprise" type="text">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" id="nom_responsable" type="text">
                                                        
                                                    </div>
                                                </div>
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        <label for="">Prenoms Responsable</label>
                                                        <input class="form-control" id="prenoms_responsable" type="text">
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" id="email_responsable" type="text">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        <label for="">Téléphone Entreprise</label>
                                                        <input class="form-control" name="Telephone_entreprise" id="telephone_entreprise" type="text">
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        <label for="">Prenoms Contact:</label>
                                                        <input class="form-control" name="prenoms_contact" id="prenoms_contact" type="text">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" id="email_contact" type="text">
                                                        
                                                    </div>
                                                </div>
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        <label for="">Téléphone Contact</label>
                                                        <input class="form-control" id="telephone_contact" type="text">
                                        ...
                                        <div class="col-sm-8">
                                                ...
                                                <label for="">Localisation</label>
                                                    <label> </label>
                                                    <textarea class="form-control" id="localisation_entreprise" rows="6"></textarea>
                                                </div>
                                        </div>
                                        </div>
                                            ...
                                            <div class="form-buttons-w">
                                                <button class="btn btn-primary disabled" id="btn_ajouter" type="submit"> Ajouter</button>
...
-------------------->
    ...
    <script>
       ...
       $( "#btn_ajouter" ).click(function(e) {
                    ...
                    var prenoms_responsable=$( "#prenoms_responsable" ).val();

                    var email_responsable=$( "#email_responsable" ).val();
                    var telephone_entreprise=$( "#telephone_entreprise" ).val();
                    var nom_contact=$( "#nom_contact" ).val();
                    var prenoms_contact=$( "#prenoms_contact" ).val();
                    var email_contact=$( "#email_contact" ).val();


                    var telephone_contact=$( "#telephone_contact" ).val();
                    var localisation_entreprise=$( "#localisation_entreprise" ).val();
                ...
                $.ajax({
                                           ...
                                           type: 'POST',
                                           url: '<?php echo base_url(); ?>administrateur/ajax_ajout_client',
                                           dataType:'json',
                                           data: {
                                           ...
                                           success: function(response) {
                                              ...
                                              if(reponse == "1"){
                                                ...
                                                alert("client enregistre avec succes");

                                                var nulle="";

                                                $('#raison_social').val(nulle);
                                                $('#rccm').val(nulle);
                                                $('#email_entreprise').val(nulle);
                                                $('#nom_responsable').val(nulle);
                                                $('#prenoms_responsable').val(nulle);

                                                $('#email_responsable').val(nulle);
                                                $('#telephone_entreprise').val(nulle);
                                                $('#nom_contact').val(nulle);

                                                $('#prenoms_contact').val(nulle);
                                                $('#email_contact').val(nulle);

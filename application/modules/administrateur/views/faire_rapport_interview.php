...
<head>
    <title>ISTjob faire rapport interview</title>
    <meta charset="utf-8">
...
-------------------->
            ...
            <input type="text" id="id_interview" value="<?php echo $id_interview; ?>">
                        <div class="element-wrapper">

                        <?php

                         if(isset($info_interview)){


                           foreach($info_interview as $val){

                             $id_offre=$val->id_offre;

                             $date=$val->date;
                             $heure_interview=$val->heure_interview;

                             $offre=$this->administrateur_model->nom_offre_id($id_offre);

                             $id_candidat=$val->id_candidat;
                             $candidat=$this->administrateur_model->nom_candidat_id($id_candidat);
                        ...
                        <input type="text" id="id_candidat" value="<?php echo $id_candidat; ?>" >
                        <input type="text" id="id_offre" value="<?php echo $id_offre; ?>" >
                            
                            <div class="element-box">
                                <h5 class="form-header">Faire un rapport d'interview</h5>
                                <div class="form-desc"> Pour le candidat : <?php echo $candidat; ?><br>pour l'offre : <?php echo $offre; ?><br> de : <?php echo $date; ?> à <?php echo $heure_interview; ?></div>
                                    ...
                                    <div class="element-box">
                                        <form id="formValidate">
                                            ...
                                            <div class="row">
                                                ...
                                                <label for="">Selectionner le status de l'interview</label>
                                                <select class="form-control" id="status_recrutement">

                                                   <option value="0">Cliquer le status de l'interview</option>

                                                    

                                                        <option value="1">candidature validée</option>
                                                        <option value="2">candidature rejetée</option>
                                        ...
                                        <div class="col-sm-8">
                                                <div class="form-group">
                                                <label for="">Conclusion ou commentaire</label>
                                                    <label> </label>
...
-------------------->
    ...
    <script>
       ...
       $( "#btn_ajouter" ).click(function(e) {
                    ...
                    var id_interview=$( "#id_interview" ).val();
                    var id_candidat=$( "#id_candidat" ).val();
                    var id_offre=$( "#id_offre" ).val();
                    var status_recrutement=$( "#status_recrutement" ).val();
                ...
                $.ajax({
                                           ...
                                           type: 'POST',
                                           url: '<?php echo base_url(); ?>administrateur/ajax_rapport_activite',
                                           dataType:'json',
                                           data: {
                                           ...
                                           success: function(response) {
                                              ...
                                              if(reponse == "1"){
                                                ...
                                                alert("Rapport enregistre avec succes");

                                                var nulle="";

                                                $('#conclusion').val(nulle);

...
<head>
    <title>ISTjob Ajouter un niveau</title>
    <meta charset="utf-8">
                    ...
                    <div class="content-box">
                        <div class="element-wrapper">
                            ...
                            <div class="element-box">
                                <h5 class="form-header">Ajouter un niveau</h5>
                                <div class="form-desc"></div>
                                 <a href="<?php echo base_url(); ?>administrateur/liste_niveaux" class="mr-2 mb-2 btn btn-primary" style="color: white;">Liste des niveaux</a>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" id="libelle_niveau" type="text">
...
-------------------->
    ...
    <script>
       ...
       $( "#btn_ajouter" ).click(function(e) {
                    ...
                    var libelle_niveau=$( "#libelle_niveau" ).val();
                ...
                $.ajax({
                                           ...
                                           type: 'POST',
                                           url: '<?php echo base_url(); ?>administrateur/ajax_ajout_niveau',
                                           dataType:'json',
                                           data: {
                                           ...
                                           success: function(response) {
                                              ...
                                              if(reponse == "1"){
                                                ...
                                                alert("niveau enregistre avec succes");

                                                var nulle="";

                                                $('#libelle_niveau').val(nulle);

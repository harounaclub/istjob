                                ...
                                <div class="element-wrapper">
                                    <div class="element-box">
                                        <form id="formValidate">
                                            ...
                                            <div class="col-sm-6">
                                                   <div class="form-group">
                                                        ...
                                                        <input class="form-control" data-match-error="Passwords don't match" placeholder="Années Experiences " id="nb_experience" type="text" required="required">
                                        ...
                                        <div class="col-lg-12">
                                          ...
                                          <div class="col-sm-12">
                                                <div class="form-group">
                                                    <label>Dossier de candidature <span style="color: red;">(*)</span></label>

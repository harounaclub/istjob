...
<head>
    <title>ISTjob Ajout un utilisateur</title>
    <meta charset="utf-8">
                    ...
                    <div class="content-box">
                        <div class="element-wrapper">
                            ...
                            <div class="element-box">
                                <h5 class="form-header">Ajouter utilisateur</h5>
                                <div class="form-desc"></div>
                                <a href="<?php echo base_url(); ?>administrateur/liste_utlisateur" class="mr-2 mb-2 btn btn-primary" style="color: white;">liste des utilisateurs</a>
                                        ...
                                        <span id="formValidate">
                                            ...
                                            <div class="element-wrapper">
                                                    ...
                                                    <div class="element-box">
                                                        ...
                                                        <form action="<?php echo base_url('administrateur/uploadPhotoAdministrateur');?>" class="dropzone" id="my-awesome-dropzone" method="POST">
                                                            <input class="form-control" type="hidden" name="id_administrateur" value="<?php echo $id_administrateur; ?>">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-4">
                              <?php echo form_open('administrateur/ajout_utlisateur'); ?>
                                     <input class="form-control" type="hidden" name="   id_administrateur" value="<?php echo $id_administrateur; ?>">

 
                                                <div class="form-group">
                                                <label for="">Nom d'utilisateur:</label>
                                                <input class="form-control" name="nom_administrateur" type="text">
                <?php echo form_error('nom_administrateur','<font color="red">','</font>'); ?>
                                                
                                            </div>
                                            </div>
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        <label for="">Prenoms utilisateur:</label>
                                                        <input class="form-control" name="prenoms_administrateur" type="text">
                <?php echo form_error('prenoms_administrateur','<font color="red">','</font>'); ?>
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" name="email_administrateur" type="text">
                <?php echo form_error('email_administrateur','<font color="red">','</font>'); ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="id_profil">
                                                    <?php 
                                                        if(isset($liste_profil)){

                                                         foreach($liste_profil as $iprofil){ ?>
                                                               
                                                               <option value="<?php echo $iprofil->id_profil;  ?>"><?php echo $iprofil->designation_profil;  ?></option>
                                            ...
                                            <div class="col-sm-4">
                                                   <div class="form-group">
                                                        ...
                                                        <input class="form-control" name="fonction_administrateur" type="text">
                                <?php echo form_error('fonction_administrateur','<font color="red">','</font>'); ?>
                                               ...
                                               <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" name="telephone_administrateur" type="text">
                                <?php echo form_error('telephone_administrateur','<font color="red">','</font>'); ?>
                                ...
                                <?php echo form_error('mdp_administrateur','<font color="red">','</font>'); ?>
                                            ...
                                            <div class="form-buttons-w">
                                                <button class="btn btn-primary" id="btn_ajouter" type="submit"> Ajouter</button>

...
<head>
    <title>ISTjob voir candidat</title>
    <meta charset="utf-8">
                ...
                <div class="content-i">
                    <div class="content-box">
                        <div class="element-wrapper">
                            ...
                            if(isset($info_generale_candidat)){

                               foreach($info_generale_candidat as $item_info){


                                   $nom_prenom_candidat=$item_info->nom_candidat." ".$item_info->prenoms_candidat;
                                   $tel_mobile=$item_info->telephone_mobil1;
                                   $date_naissance=$item_info->date_naissance;
                                   $lieu_naissance=$item_info->lieu_naissance;
                                   $email_candidat=$item_info->email_candidat;
                            ...
                            <div class="element-box">
                                <h5 class="form-header">CV candidat <?php echo $nom_prenom_candidat; ?></h5>

                                <br>
                                <h5 style="color: blue;">Tel : <?php echo $tel_mobile; ?><br> Date de naissance : <?php echo $date_naissance; ?><br>    Lieu de naissance : <?php echo $lieu_naissance; ?><br> Email : <?php echo $email_candidat; ?></h5>
                                <div class="form-desc"></div>
                                 <a href="<?php echo base_url(); ?>administrateur/ajout_dipome" class="mr-2 mb-2 btn btn-primary" style="color: white;">Retour à la liste des candidats  </a>
                                ...
                                <div class="element-wrapper">
                                    <div class="element-box">
                                        <form id="formValidate">
                                            <h5 class="form-header">Experience(s) professionnelle(s)</h5>
                                             <table id="editableTable" class="table table-editable table-striped table-lightfont">
                                    <thead>
                                        <tr>
                                            <th>#</th>
                                            <th>Entreprise</th>
                                    ...
                                    <tbody>
                                        <?php
                                    if(isset($experience_pro_candidat)){
                                        $compt=0;
                                        foreach ($experience_pro_candidat as $dip) { 
                                          $compt=$compt+1;

                                          $entreprise=$dip->entreprise;

                                          $poste_occupe=$dip->poste_occupe;
                                          $date_debut_experience=$dip->date_debut_experience;
                                          $date_fin_experience=$dip->date_fin_experience;
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $poste_occupe; ?></td>
                                            <td><?php echo $date_debut_experience; ?></td>
                                             <td><?php echo $date_fin_experience; ?></td>
                     ...
                     <div class="row">
                            <div class="col-sm-12">
                                <div class="element-wrapper">
                                    <div class="element-box">
                                        <form id="formValidate">
                                            <h5 class="form-header">Experience(s) extra professionnelle(s)</h5>
                                             <table id="editableTable" class="table table-editable table-striped table-lightfont">
                                    <thead>
                                        <tr>
                                            <th>#</th>
                                    ...
                                    <tbody>
                                        <?php
                                    if(isset($experience_extrapro_candidat)){
                                        $compt=0;
                                        foreach ($experience_extrapro_candidat as $dip) { 
                                          $compt=$compt+1;

                                          $entreprise=$dip->entreprise;

                                          $poste_occupe=$dip->poste_occupe;
                                          $date_debut_extra_experience=$dip->date_debut_extra_experience;
                                          $date_fin_extra_experience=$dip->date_fin_extra_experience;
                     ...
                     <div class="row">
                            <div class="col-sm-12">
                                <div class="element-wrapper">
                                    <div class="element-box">
                                        <form id="formValidate">
                                            <h5 class="form-header">Langue(s) parlée(s)</h5>
                                             <table id="editableTable" class="table table-editable table-striped table-lightfont">
                                    <thead>
                                        <tr>
                                            <th>#</th>
                                    ...
                                    <tbody>
                                        <?php
                                    if(isset($langues_candidat)){
                                        $compt=0;
                                        foreach ($langues_candidat as $dip) { 
                                          $compt=$compt+1;

                                          $langue=$dip->langue;
                                          $niveau_langue=$dip->niveau_langue;
                            ...
                            <div class="col-sm-12">
                                <div class="element-wrapper">
                                    <div class="element-box">
                                        <form id="formValidate">
                                            <h5 class="form-header">Loisir(s) </h5>
                                             <table id="editableTable" class="table table-editable table-striped table-lightfont">
                                    <thead>
                                        <tr>
                                            <th>#</th>
                                    ...
                                    <tbody>
                                        <?php
                                    if(isset($loisirs_candidat)){
                                        $compt=0;
                                        foreach ($loisirs_candidat as $dip) { 
                                          $compt=$compt+1;

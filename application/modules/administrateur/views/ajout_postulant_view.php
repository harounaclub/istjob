...
<head>
    <title>ISTjob Ajouter un postulants</title>
    <meta charset="utf-8">
                    ...
                    <div class="content-box">
                        <div class="element-wrapper">
                            ...
                            <div class="element-box">
                                <h5 class="form-header">Ajout un postulant</h5>
                                    ...
                                    <div class="element-box">
                                        <form id="formValidate">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" data-error="Your email address is invalid" placeholder="Intitulé de l'offre:" required="required" type="text">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" data-minlength="6" placeholder="Libelle de l'offre:" required="required" type="text">
                                                        
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <label for="">Metires</label>
                                                        <input class="form-control" data-match-error="Passwords don't match" placeholder="Metires " required="required" type="text">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label for="">Niveaux d'études</label>
                                                <select class="form-control">
                                                    <option value="New York">New York</option>
                                                    <option value="California">California</option>
                                                    <option value="Boston">Boston</option>
                                            ...
                                            <div class="col-sm-6">
                                                   <div class="form-group">
                                                        ...
                                                        <input class="form-control" data-match-error="Passwords don't match" placeholder="années Experiences " required="required" type="text">
                                             ...
                                             <div class="row">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" data-minlength="6" placeholder="Durée D'Offre:" required="required" type="text">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" data-match-error="Passwords don't match" placeholder="Lieu D'Habitation : " required="required" type="text">
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <div class="form-buttons-w">
                                                ...
                                                <button class="btn btn-primary disabled" type="submit"> Annuler</button>
                                            </div>
                                        </form>
                                    </div>

                                    ...
                                    <div class="element-box">
                                        <form id="formValidate">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" data-error="Your email address is invalid" placeholder="Intitulé de l'offre:" id="intitule_offre" type="text">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" data-minlength="6" placeholder="Libelle de l'offre:" id="libelle_offre" type="text">
                                            ...
                                            <div class="col-sm-6">
                                                   <div class="form-group">
                                                        ...
                                                        <input class="form-control" data-match-error="Passwords don't match" placeholder="Années Experiences " id="nb_experience" type="text">
                                             ...
                                             <div class="row">
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control" id="date_debut_offre" type="text" placeholder="Date debut" value="">
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            <label for="">Date Fin <span style="color: red;">(*)</span></label>
                                                            <input class="form-control" placeholder="Date fin" type="text" id="date_fin_offre">
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" data-match-error="Passwords don't match" placeholder="Lieu D'Habitation : " id="lieu_travail" type="text">
                                         ...
                                         <div class="col-sm-12">
                                               <div class="form-group">
                                                    ...
                                                    <label class="form-control-label"> Mission ou description de poste <span class="tx-danger">*</span></label>
                                        ...
                                        <div class="col-lg-12">
                                          ...
                                          <div class="col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" name="dossier_candidature" rows="3"></textarea>
                                                </div>
                                        </div>

...
<head>
    <title>ISTjob Ajouter une categorie professionnelle</title>
    <meta charset="utf-8">
                    ...
                    <div class="content-box">
                        <div class="element-wrapper">
                            ...
                            <div class="element-box">
                                <h5 class="form-header">Ajouter une categorie professionnelle</h5>
                                <div class="form-desc"></div>
                                <a href="<?php echo base_url(); ?>administrateur/liste_categorie_professionnelle" class="mr-2 mb-2 btn btn-primary" style="color: white;">Liste des categories professionnelles</a>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        <label for="">Libelle  categorie professionnelle:</label>
                                                        <input class="form-control" id="libelle_categorie" type="text">
...
-------------------->
    ...
    <script>
      ...
      $( "#btn_ajouter" ).click(function(e) {
                    ...
                    var libelle_categorie=$( "#libelle_categorie" ).val();
                ...
                $.ajax({
                                           ...
                                           type: 'POST',
                                           url: '<?php echo base_url(); ?>administrateur/ajax_ajout_categoriepro',
                                           dataType:'json',
                                           data: {
                                           ...
                                           success: function(response) {
                                              ...
                                              if(reponse == "1"){
                                                ...
                                                alert("categorie professionnelle enregistre avec succes");

                                                var nulle="";

                                                $('#libelletypecontrat').val(nulle);

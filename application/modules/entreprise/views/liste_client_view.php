...
<head>
    <title>ISTjob tous les clients</title>
    <meta charset="utf-8">
                    ...
                    <div class="content-box">
                        <div class="element-wrapper">
                            ...
                            <div class="element-box">
                                <h5 class="form-header">Tous les clients</h5>
                                <div class="form-desc"></div>
                                 <a href="<?php echo base_url(); ?>administrateur/ajout_client" class="mr-2 mb-2 btn btn-primary" style="color: white;">Ajouter un client</a>
                            ...
                            <div class="col-sm-12">
                                <div class="element-wrapper">
                                    ...
                                    if(isset($liste_clients)){
                                        $compt=0;
                                        foreach ($liste_clients as $cli) { 
                                          $compt=$compt+1;

                                          $id_entreprise=$cli->id_entreprise;

                                        ?>

                                        <tr>
                                            <td><?php echo $compt; ?></td>
                                            <td><?php echo $cli->raison_social; ?></td>
                                            <td><?php echo $cli->telephone_entreprise; ?></td>
                                             <td><?php echo $cli->email_entreprise; ?></td>
                                              <td><?php echo $cli->localisation_entreprise; ?></td>
                                            <td>
                                                <a href="" class="mr-2 mb-2 btn btn-primary" style="color: white;">Modifier</a>
                                                <a href="<?php echo base_url(); ?>administrateur/suppression_client/<?php echo $id_entreprise; ?>" class="mr-2 mb-2 btn btn-danger" style="color: white;">supprimer</a>
                                            </td>

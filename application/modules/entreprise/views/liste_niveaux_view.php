...
<head>
    <title>ISTjob tous les niveaux</title>
    <meta charset="utf-8">
                    ...
                    <div class="content-box">
                        <div class="element-wrapper">
                            ...
                            <div class="element-box">
                                <h5 class="form-header">Tous les niveaux</h5>
                                <div class="form-desc"></div>
                                <a href="<?php echo base_url(); ?>administrateur/ajout_niveaux" class="mr-2 mb-2 btn btn-primary" style="color: white;">Ajouter un niveau</a>
...
------------------  -->
                            ...
                            <div class="col-sm-12">
                                <div class="element-wrapper">
                                    ...
                                    <?php
                                    if(isset($liste_niveaux)){
                                        $compt=0;
                                        foreach ($liste_niveaux as $niv) { 
                                          $compt=$compt+1;

                                          $id_niveaux_etude=$niv->id_niveaux_etude;

                                        ?>

                                        <tr>
                                            <td><?php echo $compt; ?></td>
                                            <td><?php echo $niv->libelle_niveaux_etude; ?></td>
                                            <td><?php echo $niv->commentaire; ?></td>
                                            <td>
                                                <a href="" class="mr-2 mb-2 btn btn-primary" style="color: white;">Modifier</a>
                                                <a href="<?php echo base_url(); ?>administrateur/suppression_niveau/<?php echo $id_niveaux_etude; ?>" class="mr-2 mb-2 btn btn-danger" style="color: white;">supprimer</a>
                                            </td>

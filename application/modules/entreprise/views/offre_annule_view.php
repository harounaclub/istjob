...
<head>
    <title>ISTjob Offres annulées ...</title>
    <meta charset="utf-8">
                ...
                <div class="content-i">
                    <div class="content-box">
                        <div class="element-wrapper">
                            <h6 class="element-header">Listes de toutes les offres annulée(s) ...</h6>
                            <div class="element-box">
                                <h5 class="form-header">Listes de les offres annulée(s) ...</h5>
                                <div class="form-desc">Cette page affiche la liste de les offres annulée(s) ... </div>
                                                ...
                                                <?php
                                                  ...
                                                  if(isset($liste_offres_emplois)){ 
                                                    ...
                                                    <?php 
                                                       ...
                                                       <button class="mr-2 mb-2 btn btn-success">De publier</button>

                                                       <?php }else{ ?>

                                                       <button class="mr-2 mb-2 btn btn-danger">Publier</button>

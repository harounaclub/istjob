                                    ...
                                    <div class="element-box">
                                        <form id="formValidate">
                                            ...
                                            <div class="row">
                                                ...
                                                <input class="form-control" id="nom_administrateur" type="text">
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" id="prenoms_administrateur" type="text">
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" id="email_administrateur" type="text">
                                            ...
                                            <div class="col-sm-4">
                                                   <div class="form-group">
                                                        ...
                                                        <input class="form-control" id="fonction_administrateur" type="text">
                                               ...
                                               <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" id="telephone_administrateur" type="text">
...
-------------------->
    ...
    <script>
      ...
      $( "#btn_ajouter" ).click(function(e) {
                    ...
                    var prenoms_administrateur=$( "#prenoms_administrateur" ).val();
                   ...
                   console.log(email_administrateur);
                ...
                $.ajax({
                                           ...
                                           type: 'POST',
                                           url: '<?php echo base_url(); ?>administrateur/ajax_ajout_utilisateur',
                                           dataType:'json',
                                           data: {
                                           ...
                                           success: function(response) {
                                              ...
                                              if(reponse == "1"){
                                                ...
                                                alert("Utilisateur enregistre avec succes");

                                                var nulle="";

                                                $('#nom_administrateur').val(nulle);
                                                $('#prenoms_administrateur').val(nulle);
                                                $('#email_administrateur').val(nulle);
                                                $('#fonction_administrateur').val(nulle);
                                                $('#telephone_administrateur').val(nulle);
                                                $('#id_profil').val(nulle);

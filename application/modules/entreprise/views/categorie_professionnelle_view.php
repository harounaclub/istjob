                    ...
                    <div class="content-box">
                        <div class="element-wrapper">
                            ...
                            <div class="element-box">
                                <h5 class="form-header">Ajouter categorie professionnelle</h5>
                                    ...
                                    <div class="element-box">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" data-minlength="6"  name="categorie_professionnelle"  placeholder="categorie professionnelle" required="required" type="text">
                                        ...
                                        <div class="col-sm-8">
                                                ...
                                                <label for="">Commentaire</label>
                                                    <label> </label>
                                                    <textarea class="form-control" name="commentaire" rows="6"></textarea>
                                                </div>
                                        </div>
                                        </div>

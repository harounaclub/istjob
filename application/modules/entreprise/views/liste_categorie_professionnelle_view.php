...
<head>
    <title>ISTjob toutes les categories professionnelles</title>
    <meta charset="utf-8">
                    ...
                    <div class="content-box">
                        <div class="element-wrapper">
                            ...
                            <div class="element-box">
                                <h5 class="form-header">Tous les categories professionnelles</h5>
                                <div class="form-desc"></div>
                                 <a href="<?php echo base_url(); ?>administrateur/ajout_categorie_professionnelle" class="mr-2 mb-2 btn btn-primary" style="color: white;">Ajouter une catégorie professionnelle</a>
                                ...
                                <div class="element-wrapper">
                                    <div class="element-box">
                                        <form id="formValidate">
                                            <h5 class="form-header">Toutes les categories professionnelles</h5>
                                             <table id="editableTable" class="table table-editable table-striped table-lightfont">
                                    <thead>
                                        <tr>
                                            <th>#</th>
                                            <th>Désignation categorie</th>
                                            <th>Commentaire</th>
                                            <th>Action</th>
                                    ...
                                    <?php
                                    if(isset($liste_categorie_professionnelle)){
                                        $compt=0;
                                        foreach ($liste_categorie_professionnelle as $ctp) { 
                                          $compt=$compt+1;

                                          $id_categorie_pro=$ctp->id_categorie_pro;

                                        ?>

                                        <tr>
                                            <td><?php echo $compt; ?></td>
                                            <td><?php echo $ctp->libelle_categorie; ?></td>
                                            <td><?php echo $ctp->commentaire; ?></td>
                                            <td>
                                                <a href="" class="mr-2 mb-2 btn btn-primary" style="color: white;">Modifier</a>
                                                <a href="<?php echo base_url(); ?>administrateur/suppression_catpro/<?php echo $id_categorie_pro; ?>" class="mr-2 mb-2 btn btn-danger" style="color: white;">supprimer</a>
                                            </td>

...
<head>
    <title>ISTjob tous les types de contracts</title>
    <meta charset="utf-8">
                    ...
                    <div class="content-box">
                        <div class="element-wrapper">
                            ...
                            <div class="element-box">
                                <h5 class="form-header">Tous les types de contrats</h5>
                                <div class="form-desc"></div>
                                <a href="<?php echo base_url(); ?>administrateur/ajout_type_contract" class="mr-2 mb-2 btn btn-primary" style="color: white;">Ajouter un type de contrat</a>
...
------------------  -->
                            ...
                            <div class="col-sm-12">
                                <div class="element-wrapper">
                                    ...
                                    <tbody>
                                       <?php
                                    if(isset($liste_type_contrat)){
                                        $compt=0;
                                        foreach ($liste_type_contrat as $tc) { 
                                          $compt=$compt+1;
                                          $id_type_contrat=$tc->id_type_contrat;

                                        ?>

                                        <tr>
                                            <td><?php echo $compt; ?></td>
                                            <td><?php echo $tc->libelle_type_contrat; ?></td>
                                            <td><?php echo $tc->commentaire; ?></td>
                                            <td>
                                                <a href="" class="mr-2 mb-2 btn btn-primary" style="color: white;">Modifier</a>
                                                <a href="<?php echo base_url(); ?>administrateur/suppression_typecontrat/<?php echo $id_type_contrat; ?>" class="mr-2 mb-2 btn btn-danger" style="color: white;">supprimer</a>
                                            </td>

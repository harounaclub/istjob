...
<head>
    <title>ISTjob toutes les candidats par offres</title>
    <meta charset="utf-8">
                ...
                <div class="content-i">
                    <div class="content-box">
                        <div class="element-wrapper">
                            <h6 class="element-header">Listes de toutes les candidats selectionnés par offres</h6>
                            <div class="element-box">
                                <h5 class="form-header">Listes de toutes les candidats selectionnés par offres</h5>
                                                ...
                                                <?php
                                                  ...
                                                  if(isset($liste_offres_emplois)){ 
                                                    ...
                                                    <td class="row-actions">
                                                       ...
                                                       <a href="<?php echo base_url(); ?>administrateur/liste_selection_candidat_offre/<?php echo $id_offre; ?>" class="mr-2 mb-2 btn btn-success" style="color: white;">Consulter la liste </a>

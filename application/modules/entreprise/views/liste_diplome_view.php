...
<head>
    <title>ISTjob tous les diplomes</title>
    <meta charset="utf-8">
                    ...
                    <div class="content-box">
                        <div class="element-wrapper">
                            ...
                            <div class="element-box">
                                <h5 class="form-header">Tous les diplomes</h5>
                                <div class="form-desc"></div>
                                 <a href="<?php echo base_url(); ?>administrateur/ajout_dipome" class="mr-2 mb-2 btn btn-primary" style="color: white;">Liste des diplomes</a>
                            ...
                            <div class="col-sm-12">
                                <div class="element-wrapper">
                                    ...
                                    if(isset($liste_diplome)){
                                        $compt=0;
                                        foreach ($liste_diplome as $dip) { 
                                          $compt=$compt+1;
                                          $id_diplome=$dip->id_diplome;

                                        ?>

                                        <tr>
                                            <td><?php echo $compt; ?></td>
                                            <td><?php echo $dip->libelle_diplome; ?></td>
                                            <td><?php echo $dip->commentaire; ?></td>
                                            <td>
                                                <a href="" class="mr-2 mb-2 btn btn-primary" style="color: white;">Modifier</a>
                                                <a href="<?php echo base_url(); ?>administrateur/suppression_diplome/<?php echo $id_diplome; ?>" class="mr-2 mb-2 btn btn-danger" style="color: white;">supprimer</a>
                                            </td>

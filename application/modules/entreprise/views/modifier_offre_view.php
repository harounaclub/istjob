                    ...
                    <div class="content-box">
                        <div class="element-wrapper">
                            ...
                            <div class="element-box">
                                <h5 class="form-header">Modifier une offre d'emploi</h5>
...
------------------  -->
                                ...
                                <div class="element-wrapper">
                                    <div class="element-box">
                                        ...
                                        <?php 
                                  if(isset($infos_offre)){

                                    $compt=0;
                                    foreach($infos_offre as $item_offre){ 

                                     $compt=$compt+1;
                                     $id_offre=$item_offre->id_offre;
                                     $status=$item_offre->status_offre;
                                     $id_entreprise=$item_offre->id_entreprise;
                                     $entreprise=$this->administrateur_model->get_nom_entreprise($id_entreprise);
...
<input class="form-control"  id="id_offre" type="hidden" value="<?php echo $id_offre; ?>">

<span id="zone_o" >
                                        
                                           <div class="form-group">
                                              
                                                <label for="">Selectionner une entreprise</label>
                                                <select class="form-control" id="id_entreprise">
                                                     <option value="?php echo $id_entreprise; ?>"><?php echo $entreprise; ?></option>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" id="intitule_offre" type="text" value="<?php echo $item_offre->intitule_offre; ?>">
                                                
                                            </div>
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <label for=""> Libelle de l'offre:</label>
                                                        <input class="form-control"  id="libelle_offre" type="text" value="<?php echo $item_offre->libelle_offre; ?>">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" id="metiers" type="text" value="<?php echo $item_offre->metier; ?>">
                                            ...
                                            <div class="col-sm-6">
                                                 <div class="form-group">
                                                      <label for=""> Niveau(x) d'etude(s)</label>
                                                      <select class="form-control select2" id="niveaux" multiple="true">
                                                          <?php 
                                                      $list_niveau=$this->administrateur_model->get_tous_niveau_offre($id_offre);
                                                      foreach($list_niveau as $niv){ 

                                                        $id_niveaux_etude=$niv->id_niveau_etude;

                                                        $niveau=$this->administrateur_model->get_nom_niveau_etude($id_niveaux_etude);

                                                      ?>

                                                      <option selected="true"><?php echo $niveau; ?> </option>
                                            ...
                                            <div class="col-sm-6">
                                                   <div class="form-group">
                                                        ...
                                                        <label for="">Nb.années Experiences</label>
                                                        <input class="form-control"  id="nb_experience" type="text" value="<?php echo $item_offre->nb_experience; ?>">
                                             ...
                                             <div class="row">
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control" id="date_debut_offre" type="text" value="<?php echo $item_offre->date_debut_offre; ?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            <label for="">Date Fin</label>
                                                            <input class="form-control" placeholder="Date fin" type="text" id="date_fin_offre" value="<?php echo $item_offre->date_fin_offre; ?>">
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" data-minlength="6" placeholder="Durée D'Offre:" id="dure_offre" type="text" value="<?php echo $item_offre->duree_offre; ?>">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" data-match-error="Passwords don't match" placeholder="Lieu D'Habitation : " id="lieu_habitation" type="text" value="<?php echo $item_offre->lieu_habitation; ?>">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" data-match-error="Passwords don't match" placeholder="Lieu D'Habitation : " id="lieu_travail" type="text" value="<?php echo $item_offre->lieu_travail; ?>">
                                                ...
                                                <div class="col-sm-6">
                                                 <div class="form-group">
                                                      ...
                                                      <select class="form-control select2" id="diplomes" multiple="true">
                                                          <?php 
                                                      $list_diplome=$this->administrateur_model->get_tous_diplome_offre($id_offre);
                                                      foreach($list_diplome as $dp){ 

                                                        $id_diplome=$dp->id_diplome;

                                                        $diplome=$this->administrateur_model->get_nom_diplome($id_diplome);

                                                      ?>

                                                      <option selected="true"><?php echo $diplome; ?> </option>
                                             ...
                                             <div class="col-sm-6">
                                                 <div class="form-group">
                                                      ...
                                                      <select class="form-control select2" id="typecontrat" multiple="true">
                                                        <?php 
                                                      $list_type_contrat=$this->administrateur_model->get_tous_contrat_offre($id_offre);
                                                      foreach($list_type_contrat as $cont){ 

                                                        $id_type_contrat=$cont->id_type_contrat;

                                                        $contrat=$this->administrateur_model->get_nom_contrat($id_type_contrat);

                                                      ?>

                                                      <option selected="true"><?php echo $contrat; ?> </option>
                                          ...
                                          <div class="col-sm-6">
                                             ...
                                             <div class="form-group">
                                                      <label for=""> Categories professionnelles</label>
                                                      <select class="form-control select2" id="id_categorie_pro" multiple="true">
                                                          <?php 
                                                      $list_cat_pro=$this->administrateur_model->get_tous_catpro_offre($id_offre);
                                                      foreach($list_cat_pro as $cp){ 

                                                        $id_categorie_pro=$cp->id_categorie_pro;

                                                        $catpro_lib=$this->administrateur_model->get_nom_catpro($id_categorie_pro);

                                                      ?>

                                                      <option selected="true"><?php echo $catpro_lib; ?> </option>
                                         ...
                                         <div class="col-lg-12">
                                          <div class="form-group">
                                             ...
                                             <label class="form-control-label"> Profil du poste <span class="tx-danger"></span></label>
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <label class="form-control-label"> Autre description <span class="tx-danger">*</span></label>
                                               

                                                <div id="description_offre"><br>Saisir toutes les autres informations de l'emploi </div>
                                          ...
                                          <div class="col-sm-12">
                                                <div class="form-group">
                                                    <label>Descrition du Dossier de candidature </label>
                                         ...
                                         <div class="col-sm-12">
                                                <div class="form-group">
                                                   ...
                                                   <div id="zone_cacher">
                                                    <textarea class="form-control" rows="4" id="mission_set"><?php echo $item_offre->mission; ?></textarea>
                                                    <textarea class="form-control" rows="4" id="profil_poste_set"><?php echo $item_offre->profil_poste; ?></textarea>
                                                    <textarea class="form-control" rows="4" id="description_offre_set"><?php echo $item_offre->description_offre; ?></textarea>
                                                   </div>
                                                </div>
                                        </div>
                                            ...
                                            <div class="form-buttons-w">
                                                <button class="btn btn-primary disabled" type="submit" id="btn_ajouter"> Modifier l'offre</button>
...
-------------------->
    ...
    <script>
        ...
        var mission_h=$("#mission_set").val();
        var profile_h=$("#profil_poste_set").val();
        var description_h=$("#description_offre_set").val();
        

        // Summernote editor

        $('#mission').summernote('code', mission_h);
         $('#profil_poste').summernote('code', profile_h);
         $('#description_offre').summernote('code', description_h);
        ...
        $( "#btn_ajouter" ).click(function(e) {
                    ...
                    var dossier_candidature=$('#dossier_candidature').val();
                ...
                $.ajax({
                                           ...
                                           type: 'POST',
                                           url: '<?php echo base_url(); ?>administrateur/modifier_offre/'+id_offre,
                                           dataType:'json',
                                           data: {
                                           ...
                                           success: function(response) {
                                              ...
                                              if(reponse == "1"){
                                                ...
                                                $("#zone_o").hide();
                                                alert("Offre Modifier avec succes");

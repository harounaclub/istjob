...
<head>
    <title>ISTjob Ajouter une interview</title>
    <meta charset="utf-8">
                    ...
                    <div class="content-box">
                        <div class="element-wrapper">
                            ...
                            <div class="element-box">
                                <h5 class="form-header">Ajouter une interview</h5>
                                    ...
                                    <div class="element-box">
                                        <form id="formValidate">
                                            ...
                                            <div class="row">
                                                ...
                                                <label for="">Selectionner une offre</label>
                                                <select class="form-control" id="id_offre">

                                                   <option value="0">Cliquer pour selectionner une offre</option>

                                                    <?php 
                                                      if(isset($liste_offre)){

                                                        foreach ($liste_offre as $offre) { ?>

                                                        <option value="<?php echo $offre->id_offre; ?>"><?php echo $offre->libelle_offre; ?></option>
                                            ...
                                            <div class="col-sm-4">
                                                ...
                                                <label for="">Selectionner candidat</label>
                                                <select class="form-control" id="id_candidat">

                                                     <option value="0">Cliquer pour selectionner un candidat</option>

                                                    <?php 
                                                      if(isset($liste_candidats)){

                                                        foreach ($liste_candidats as $candidat) { ?>

                                                        <option value="<?php echo $candidat->id_candidat; ?>"><?php echo $candidat->nom_candidat." ".$candidat->prenoms_candidat; ?></option>
                                            ...
                                            <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" id="heure_interview" type="text">
...
-------------------->
    ...
    <script>
       ...
       $( "#btn_ajouter" ).click(function(e) {
                    ...
                    var date=$( "#date" ).val();
                    var heure_interview=$( "#heure_interview" ).val();
                ...
                $.ajax({
                                           ...
                                           type: 'POST',
                                           url: '<?php echo base_url(); ?>administrateur/ajax_ajout_interview',
                                           dataType:'json',
                                           data: {
                                           ...
                                           success: function(response) {
                                              ...
                                              if(reponse == "1"){
                                                ...
                                                alert("interview enregistre avec succes");

                                                var nulle="";

                                                $('#date').val(nulle);
                                                $('#heure_interview').val(nulle);

...
<head>
    <title>ISTjob Rapport en attente interview</title>
    <meta charset="utf-8">
                    ...
                    <div class="content-box">
                        <div class="element-wrapper">
                            ...
                            <div class="element-box">
                                <h5 class="form-header">Rapport en attente interview</h5>
...
------------------  -->
                            ...
                            <div class="col-sm-12">
                                <div class="element-wrapper">
                                    ...
                                    <tbody>
                                        <?php
                                    if(isset($liste_interview)){
                                        $compt=0;
                                        foreach ($liste_interview as $dip) { 
                                          $compt=$compt+1;
                                          $id_interview=$dip->id_interview;
                                          $status_recrutement=$dip->status_recrutement;
                                          $id_offre=$dip->id_offre;
                                          $id_candidat=$dip->id_candidat;
                                          $date=$dip->date;
                                          $heure_interview=$dip->heure_interview;
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $date; ?></td>
                                            <td><?php echo $heure_interview; ?></td>
                                            <td>

                                            <?php 
                                            if($status_recrutement ==0){ ?>

                                                <a href="<?php echo base_url(); ?>administrateur/faire_rapport_interview/<?php echo $id_interview; ?>" class="mr-2 mb-2 btn btn-primary" style="color: white;">Faire un rapport</a>


                                           <?php }else{ ?>

                                                 <a href="<?php echo base_url(); ?>administrateur/faire_rapport_interview/<?php echo $id_interview; ?>" class="mr-2 mb-2 btn btn-success" style="color: white;">Rapport executé</a>

...
<head>
    <title>ISTjob candidats par offre</title>
    <meta charset="utf-8">
                    ...
                    <div class="content-box">
                        <div class="element-wrapper">
                            ...
                            <div class="element-box">
                                <h5 class="form-header">Candidats pour offre "<?php echo $libelle_offre; ?>"</h5>
                                ...
                                <div class="element-wrapper">
                                    <div class="element-box">
                                        <form id="formValidate">
                                            <h5 class="form-header">Liste des candidats ayant postulé à "<?php echo $libelle_offre; ?>"</h5>
                                    ...
                                    <tbody>
                                               ...
                                               if(isset($liste_offres_emplois)){ 

                                               $compt=0;

                                                foreach($liste_offres_emplois as $tcan){

                                                  $compt=$compt+1;
                                                  $id_candidat=$tcan->id_candidat;
                                                  $id_offre=$tcan->id_offre;


                                                  $infos_candidat=$this->administrateur_model->get_info_generale_candidat($id_candidat);

                                                  $offre_intitule=$this->administrateur_model->nom_offre_id($id_offre);

                                                  $status_position=$tcan->status_position;

                                                  foreach ($infos_candidat as $valeur) {
                                               ...
                                               <tr>
                                                    ...
                                                    <td ><?php echo $valeur->nom_candidat." ".$valeur->prenoms_candidat;  ?> </td>
                                                    <td ><?php echo $valeur->telephone_mobil1;  ?> </td>
                                                    
                                                    <td ><?php echo $valeur->date_naissance;  ?> </td>

                                                     <td ><?php echo $valeur->lieu_naissance;  ?> </td>

                                                     <td ><?php echo $offre_intitule;  ?> </td>
                                                    ...
                                                    <td>
                                                         <a href="<?php echo base_url(); ?>administrateur/voir_candidat/<?php echo $id_candidat; ?>" class="btn btn-primary"><div><i class="fa fa-twitter"></i></div>Voir cv </a>
                                                       ...
                                                       <a href="<?php echo base_url(); ?>administrateur/selectionner_candidat_par_offre/<?php echo $id_candidat; ?>/<?php echo $id_offre; ?>" class="btn btn-success"><div><i class="fa fa-twitter"></i></div>Sélectionner </a>


                                                     <?php
                                                       }else{ ?>

                                                       <a href="<?php echo base_url(); ?>administrateur/deselectionner_candidat_par_offre/<?php echo $id_candidat; ?>/<?php echo $id_offre; ?>" class="btn btn-danger"><div><i class="fa fa-twitter"></i></div>Desélectionner </a>

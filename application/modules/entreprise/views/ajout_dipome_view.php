...
<head>
    <title>ISTjob Ajouter un diplome</title>
    <meta charset="utf-8">
                    ...
                    <div class="content-box">
                        <div class="element-wrapper">
                            ...
                            <div class="element-box">
                                ...
                                <a href="<?php echo base_url(); ?>administrateur/liste_diplome" class="mr-2 mb-2 btn btn-primary" style="color: white;">Liste des diplomes</a>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" id="libelle_diplome" type="text">
...
-------------------->
    ...
    <script>
      ...
      $( "#btn_ajouter" ).click(function(e) {
                    ...
                    var libelle_diplome=$( "#libelle_diplome" ).val();
                ...
                $.ajax({
                                           ...
                                           type: 'POST',
                                           url: '<?php echo base_url(); ?>administrateur/ajax_ajout_diplome',
                                           dataType:'json',
                                           data: {
                                           ...
                                           success: function(response) {
                                              ...
                                              if(reponse == "1"){
                                                ...
                                                alert("Diplome enregistre avec succes");

                                                var nulle="";

                                                $('#libelle_diplome').val(nulle);

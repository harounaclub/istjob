                ...
                <div class="content-i">
                    <div class="content-box">
                        <div class="element-wrapper">
                            <h6 class="element-header">Mes loisire</h6>
                            <div class="element-box">
                                <h5 class="form-header">Mes loisire</h5>
                                <div class="form-desc">:</div>

                                <div class="form-buttons-w">
                                 <a href="<?php echo base_url(); ?>candidat/ajout_loisire" class="btn btn-primary" >Ajouter</a>
                                </div>
                                <br>

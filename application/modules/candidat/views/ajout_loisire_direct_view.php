...
<head>
    <title>ISTjob Ajouter loisire et hobbies</title>
    <meta charset="utf-8">
                    ...
                    <div class="content-box">
                        <div class="element-wrapper">
                            ...
                            <div class="element-box">
                                <h5 class="form-header">Ajouter loisir</h5>
                                ...
                                <div class="element-wrapper">
                                    <div class="element-box">
                                        <span id="formValidate">
                                            <h5 class="form-header">Ajouter  loisir et hobbies</h5>
                                            ...
                                            <div class="row">
                                                 <div class="col-sm-6">
                                     <?php echo form_open('candidat/ajout_loisire_direct'); ?>
                                                <div class="form-group">
                                                        <label for="">Loisir</label>
                                                        <input class="form-control" placeholder="Enter  votre loisir " type="text" name="select_loi">
                                         <?php echo form_error('select_loi','<font color="red">','</font>'); ?>

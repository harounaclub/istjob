                                ...
                                <div class="element-wrapper">
                                    <div class="element-box">
                                        <span id="formValidate">
                                            ...
                                            <div class="form-desc">Vos hobbies et loisirs nous permettent de mieux vous connaitre, remplisser donc avec soin cette rubrique. 


                                            <div class="row">
                                                 <div class="col-sm-6">
                                     <?php echo form_open('candidat/assistant_hobbie'); ?>

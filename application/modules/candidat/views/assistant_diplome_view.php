...
<head>
    <title>Etape 3/ 6 diplômes</title>
    <meta charset="utf-8">
                ...
                <div class="content-i">
                    <div class="content-box">
                        <div class="element-wrapper">
                            <h6 class="element-header">Etape 3/ 6 diplômes </h6>
                            <div class="form-buttons-w">
                                 <a href="<?php echo base_url(); ?>candidat/redirige_exp_extra_pro" class="btn btn-primary" >Etape suivante</a>
                            </div>
                            <div class="element-box">
                                <h5 class="form-header">Etape 3/ 6 diplômes</h5>
                                <div class="form-desc">
                                   
                                                Cette étape nous permet de recenser l'ensemble de vos diplômes.<br>
                                                Pour ajouter un diplôme cliquer sur le bouton "Ajouter un diplôme" puis remplir le formulaire <br> une fois terminée , cliquer sur Etape suivante<br>N.B: si vous n'avez aucun diplôme,cliquer directement sur Etape suivante </div>
                                                <a href="<?php echo base_url(); ?>candidat/ajout_diplomes" class="btn btn-primary" >Ajouter un diplôme</a>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-lg table-v2 table-striped">
                                            ...
                                            <tbody>
                                               ...
                                               if(isset($liste_dipl_candidat)){ 

                                               $compt=0;

                                                 foreach($liste_dipl_candidat as $dipl){

                                                 $id_diplome_candidat=$dipl->id_diplome_candidat;
                                               ...
                                               <tr>
                                                    ...
                                                    <td ><?php echo $dipl->date_debut;  ?> </td>
                                                    <td ><?php echo $dipl->date_fin;  ?> </td>
                                                    <td ><?php echo $dipl->libelle_diplome_candidat;  ?> </td>
                                                   
                                                    
                                                    <td>
                                                         <a href="<?php echo base_url(); ?>candidat/supprim_assistant_diplome/<?php echo $id_diplome_candidat;?>" class="btn btn-danger"><div><i class="fa fa-twitter"></i></div>Supprimer</a>
                                                    </td>

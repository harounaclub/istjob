...
<head>
    <title>Etape 1/ 6 Informations générales</title>
    <meta charset="utf-8">
                    ...
                    <div class="content-box">
                        <div class="element-wrapper">
                            ...
                            <div class="element-box">
                                <h5 class="form-header">Etape 1/ 6 Informations générales</h5>
...
------------------  -->
                            ...
                            <div class="col-sm-12">
                                <div class="element-wrapper">
                                    <div class="element-box">
                                        <span id="formValidate">
                                            <h5 class="form-header">Informations générales</h5>
                                            <div class="form-desc">Dans cette rubrique , nous allons collecter vos informations personnelles telles que nom,prenom(s) etc ...</a></div>

                                            <div class="element-wrapper">
                           
                                                    <div class="element-box">
                                                       
                                                        <form action="<?php echo base_url('candidat/uploadPhotoCandidat');?>" class="dropzone" id="my-awesome-dropzone" method="POST">
                                                            
                                                            <div class="dz-message">
                                                                <div>
                                                                    <h4>Glisser et deposer votre photo (200 x 200 px).</h4>
                                            ...
                                            <div class="row">
                                            <div class="col-sm-6">
                                    <?php echo form_open('candidat/assistant_information_generale'); ?>
                                            <div class="form-group">
                                                <label for=""> Nom</label>
                                                <input class="form-control" data-error="Veuillez renseigner votre nom" placeholder="Entrer le nom" required="required" type="text" name="nom">
                                    <?php echo form_error('nom','<font color="red">','</font>'); ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" data-error="Veuillez renseigner votre prenom" placeholder="Entrer le prenom" required="required" type="text" name="prenom">
                                    <?php echo form_error('prenom','<font color="red">','</font>'); ?>
                                                <div class="help-block form-text with-errors form-control-feedback"></div>
                                            </div>
                                            </div>
                                            </div>
                                            ...
                                            <div class="col-sm-6">
                                             <div class="form-group">
                                                ...
                                                <input class="form-control" data-error="Your email address is invalid" placeholder="Entrer la date de naissance" required="required" type="text" name="date_naissance">
                                    <?php echo form_error('date_naissance','<font color="red">','</font>'); ?>
                                                <div class="help-block form-text with-errors form-control-feedback"></div>
                                            </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" data-error="Your email address is invalid" placeholder=" Entrer le lieu de naissance" required="required" type="text" name="lieu_naissance">
                                    <?php echo form_error('lieu_naissance','<font color="red">','</font>'); ?>
                                                <div class="help-block form-text with-errors form-control-feedback"></div>
                                            </div>
                                            </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" data-error="Your email address is invalid" placeholder="Entrer la Nationnalite" required="required" type="text" name="nationnalite">
                                    <?php echo form_error('nationnalite','<font color="red">','</font>'); ?>
                                                <div class="help-block form-text with-errors form-control-feedback"></div>
                                            </div>
                                            </div>
                                            ...
                                            <div class="col-sm-6">
                                            <div class="form-group">
                                                <label for="">Email candidat</label>
                                                <input class="form-control" data-error="Your email address is invalid" placeholder="Entrer votre email" required="required" type="text" name="email_candidat" value="<?php echo $email_candidat;?>">
                                    <?php echo form_error('email_candidat','<font color="red">','</font>'); ?>
                                            ...
                                            <div class="col-sm-6">
                                            <div class="form-group">
                                                <label for="">Téléphone mobile 1</label>
                                                <input class="form-control" data-error="Your email address is invalid" placeholder="Entrer le téléphone mobile 1" required="required" type="text" name="tel_mob_1">
                                    <?php echo form_error('tel_mob_1','<font color="red">','</font>'); ?>
                                            ...
                                            <div class="col-sm-6">
                                            <div class="form-group">
                                                <label for="">Téléphone mobile 2</label>
                                                <input class="form-control" data-error="Your email address is invalid" placeholder="Entrer le téléphone mobile 2" required="required" type="text" name="tel_mob_2">
                                    <?php echo form_error('tel_mob_2','<font color="red">','</font>'); ?>
                                                <div class="help-block form-text with-errors form-control-feedback"></div>
                                            </div>
                                            </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" data-error="Your email address is invalid" placeholder="Entrer le Téléphone fixe" required="required" type="text" name="tel_fix">
                                    <?php echo form_error('tel_fix','<font color="red">','</font>'); ?>
                                                <div class="help-block form-text with-errors form-control-feedback"></div>
                                            </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" data-error="Your email address is invalid" placeholder="Entrer le nombre d'enfants" required="required" type="text" name="nbre_enfants">
                                    <?php echo form_error('nbre_enfants','<font color="red">','</font>'); ?>
                                                <div class="help-block form-text with-errors form-control-feedback"></div>
                                            </div>
                                            </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="select_marital">
                                                    <option value="Marié(e)">Marié(é)</option>
                                                    <option value="Celibataire">Celibataire</option>
                                    <?php echo form_error('select_marital','<font color="red">','</font>'); ?>

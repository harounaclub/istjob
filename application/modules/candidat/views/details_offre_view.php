...
<?php 
                                  if(isset($infos_offre)){
                                    ...
                                    foreach($infos_offre as $item_offre){ 
                                     ...
                                     $entreprise=$this->candidat_model->get_nom_entreprise($id_entreprise);
                            ...
                            <div class="element-box">
                                <h5 class="form-header">Details de l'offre </h5>
                                <div class="form-desc"></div>
                                <a href="<?php echo base_url(); ?>candidat/postuler_maintenant/<?php echo $id_offre; ?>/<?php echo $id_candidat; ?>" class="mr-2 mb-2 btn btn-primary" style="color: white;">Postuler Maintenant</a>
                                    ...
                                    <div class="element-box">
                                        <form id="formValidate">
                                           ...
                                           <div class="form-group">
                                                ...
                                                <input class="form-control"  type="text" value="<?php echo $entreprise; ?>">
                                                
                                            </div>
                                        
                                            <div class="form-group">
                                                <label for=""> Intitulé de l'offre:</label>
                                                <input class="form-control"  type="text" value="<?php echo $item_offre->intitule_offre; ?>">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" type="text" value="<?php echo $item_offre->libelle_offre; ?>">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <label for="">Metiers</label>
                                                        <input class="form-control" type="text" value="<?php echo $item_offre->metier; ?>">
                                           ...
                                           <div class="col-sm-6">
                                                 <div class="form-group">
                                                    ...
                                                    <?php 
                                                      $list_niveau=$this->candidat_model->get_tous_niveau_offre($id_offre);
                                                      ...
                                                      foreach($list_niveau as $niv){ 
                                                        ...
                                                        $niveau=$this->candidat_model->get_nom_niveau_etude($id_niveaux_etude);
                                            ...
                                            <div class="col-sm-6">
                                                   <div class="form-group">
                                                        ...
                                                        <input class="form-control" type="text" value="<?php echo $item_offre->nb_experience; ?> ans">
                                             ...
                                             <div class="row">
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control" placeholder="" type="text" value="<?php echo $item_offre->date_debut_offre; ?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            <label for="">Date Fin</label>
                                                            <input class="form-control" placeholder="" type="text" value="<?php echo $item_offre->date_fin_offre; ?>">
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" type="text" value="<?php echo $item_offre->duree_offre; ?>">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" type="text" value="<?php echo $item_offre->lieu_habitation; ?>">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" type="text" value="<?php echo $item_offre->lieu_travail; ?>">
                                             ...
                                             <div class="form-group">
                                                      ...
                                                      <select class="form-control select2" multiple="true">
                                                          ...
                                                          <?php 
                                                      $list_diplome=$this->candidat_model->get_tous_diplome_offre($id_offre);
                                                      foreach($list_diplome as $dp){ 

                                                        $id_diplome=$dp->id_diplome;

                                                        $diplome=$this->candidat_model->get_nom_diplome($id_diplome);
                                            ...
                                            <div class="row">
                                             <div class="col-sm-6">
                                                 <div class="form-group">
                                                      ...
                                                      <select class="form-control select2" multiple="true">
                                                        <?php 
                                                      $list_type_contrat=$this->candidat_model->get_tous_contrat_offre($id_offre);
                                                      ...
                                                      foreach($list_type_contrat as $cont){ 
                                                        ...
                                                        $contrat=$this->candidat_model->get_nom_contrat($id_type_contrat);
                                          ...
                                          <div class="col-sm-6">
                                             ...
                                             <div class="form-group">
                                                      ...
                                                      <select class="form-control select2" multiple="true">
                                                          ...
                                                          <?php 
                                                      $list_cat_pro=$this->candidat_model->get_tous_catpro_offre($id_offre);
                                                      foreach($list_cat_pro as $cp){ 

                                                        $id_categorie_pro=$cp->id_categorie_pro;

                                                        $catpro_lib=$this->candidat_model->get_nom_catpro($id_categorie_pro);
                                         ...
                                         <div class="col-sm-12">
                                               <div class="form-group">
                                                    ...
                                                    <div id="mission"><br>Hello, universe!</div>
                                         ...
                                         <div class="col-lg-12">
                                          <div class="form-group">
                                             ...
                                             <label class="form-control-label"> Profil du poste <span class="tx-danger"></span></label>
                                              ...
                                              <div id="profil_poste"><br>Hello, universe!</div>
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <label class="form-control-label"> Autre description <span class="tx-danger">*</span></label>
                                                ...
                                                <div id="description_offre"><br>Hello, universe!</div>
                                          ...
                                          <div class="col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" rows="4"><?php echo $item_offre->dossier_candidature; ?></textarea>
                                                </div>
                                        </div>

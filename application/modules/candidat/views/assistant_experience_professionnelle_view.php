...
<head>
    <title>Etape 2/ 6 Experiences Professionnelles</title>
    <meta charset="utf-8">
                ...
                <div class="content-i">
                    <div class="content-box">
                        <div class="element-wrapper">
                            <h6 class="element-header">Etape 2/ 6 Experiences Professionnelles </h6>
                            <div class="form-buttons-w">
                                 <a href="<?php echo base_url(); ?>candidat/redirige_diplome" class="btn btn-primary" >Etape suivante</a>
                            </div>
                            <div class="element-box">
                                <h5 class="form-header">Etape 2/ 6 Experiences Professionnelles</h5>
                                
                               

                            <div class="form-desc">
                                                Cette étape nous permet de recenser l'ensemble de vos expériences professionnelles.<br>
                                                Pour ajouter une expérience professionnelle cliquer sur le bouton "Ajouter expérience professionnelle" puis remplir le formulaire <br> une fois terminée , cliquer sur Etape suivante<br>N.B: si vous n'avez aucune expérience professionnelle ,cliquer directement sur Etape suivante </div>

                             <a href="<?php echo base_url(); ?>candidat/ajout_experience_professionnelles" class="btn btn-primary" >Ajouter une expérience professionnelle</a>
                               <div class="row">
                                <div class="col-sm-4">
                                <div class="form-buttons-w">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-lg table-v2 table-striped">
                                            ...
                                            <?php
                                               ...
                                               if(isset($liste_exp_pro_candidat)){ 

                                               $compt=0;

                                                 foreach($liste_exp_pro_candidat as $exp){
                                               ...
                                               <tr>
                                                    ...
                                                    <td ><?php echo $exp->date_debut_experience;  ?> </td>
                                                    <td ><?php echo $exp->date_fin_experience;  ?> </td>
                                                    <td ><?php echo $exp->entreprise;  ?> </td>
                                                    <td ><?php echo $exp->poste_occupe;  ?> </td>
                                                    <td ><?php echo $exp->description_poste;  ?> </td>
                                                    
                                                    <td>
                                                         <a href="<?php echo base_url(); ?>candidat/supprim_assistant_expe_pro/<?php echo $id_experience;?>" class="btn btn-danger"><div><i class="fa fa-twitter"></i></div>Supprimer</a>
                                                    </td>

...
<head>
    <title>Etape 7/ 7 Finalisation  </title>
    <meta charset="utf-8">
                ...
                <div class="content-i">
                    <div class="content-box">
                        <div class="element-wrapper">
                            <h6 class="element-header">Etape 7/ 7 Finalisation </h6>
                             <div class="form-buttons-w">
                                 
                            </div>
                            <div class="element-box">
                                <h5 class="form-header">Etape 7/ 7 Finalisation </h5>
                                <div class="form-desc">


                                   
                                               <h2 style="color: green;">Bravo , vous êtes arrivé au bout de la configuration de votre compte !</h2>

                                               <h5>Vous pouvez maintenant postuler à l'ensemble de nos offres d'emplois en ligne ,toutefois n'hesiter pas mettre vos CV à jour via le menu votre CV en ligne.</h5>
...
------------------  -->
                                    ...
                                    <div class="form-buttons-w">
                                 <a href="<?php echo base_url(); ?>candidat/tableau_bords" class="btn btn-primary" >Continuer vers le tableau de bords</a>
                            </div>

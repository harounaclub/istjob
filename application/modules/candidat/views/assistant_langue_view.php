                ...
                <div class="content-i">
                    <div class="content-box">
                        <div class="element-wrapper">
                            <h6 class="element-header">Etape 6/ 6 Langues</h6>
                             <div class="form-buttons-w">
                                 <a href="<?php echo base_url(); ?>candidat/redirige_tableau_bords" class="btn btn-primary" >Etape suivante</a>
                            </div>
                            <div class="element-box">
                                <h5 class="form-header">Etape 6/ 6 Langues</h5>
                                <div class="form-desc">
                                   
                                                Cette étape nous permet de recenser l'ensemble de vos langues parlées ,lus et ecris.<br>
                                                Pour ajouter une langue cliquer sur le bouton "Ajouter une langue" puis remplir le formulaire <br> une fois terminée , cliquer sur Etape suivante<br> </div>
                                        ...
                                        <table class="table table-bordered table-lg table-v2 table-striped">
                                            ...
                                            <tbody>
                                               ...
                                               <tr>
                                                    ...
                                                    <td>
                                                         <a href="<?php echo base_url(); ?>candidat/supprim_assistant_langue/<?php echo $id_langue_candidat;?>" class="btn btn-danger"><div><i class="fa fa-twitter"></i></div>Supprimer</a>
                                                    </td>

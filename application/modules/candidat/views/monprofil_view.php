...
------------------  -->
                            ...
                            <div class="col-sm-12">
                                <div class="element-wrapper">
                                    <div class="element-box">
                                        <span id="formValidate">
                                            <h5 class="form-header">Information general</h5>
                                            <div class="form-desc">Validation of the form is made possible using powerful validator plugin for bootstrap. <a href="http://1000hz.github.io/bootstrap-validator/" target="_blank">Learn more about Bootstrap Validator</a></div>
                                ...
                                <?php echo form_error('email_candidat','<font color="red">','</font>'); ?>
                                            ...
                                            <div class="col-sm-6">
                                            <div class="form-group">
                                                <label for="">téléphone mobil 1</label>
                                ...
                                <?php echo form_error('tel_mob_1','<font color="red">','</font>'); ?>
                                            ...
                                            <div class="col-sm-6">
                                            <div class="form-group">
                                                <label for="">téléphone mobil 2</label>
                                ...
                                <?php echo form_error('tel_fix','<font color="red">','</font>'); ?>
                                            ...
                                            <div class="col-sm-6">
                                            <div class="form-group">
                                                <label for="">Changer Mot de passe passe</label>
                                                <input class="form-control"  type="text" name="AncienMdp" placeholder=" Ancien Mot de passe">
                                <?php echo form_error('AncienMdp','<font color="red">','</font>'); ?>
                                            ...
                                            <div class="col-sm-6">
                                            <div class="form-group">
                                                <label for="">Re-saisir Mot de passe</label>
                                                <input class="form-control"  type="text" name="NouveauMdp" placeholder=" Nouveau Mot de passe" >
                                <?php echo form_error('NouveauMdp','<font color="red">','</font>'); ?>

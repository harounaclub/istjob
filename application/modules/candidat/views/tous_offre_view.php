                            ...
                            <div class="element-box">
                                ...
                                <div class="form-desc">You can put a table tag inside an <code>.element-box</code> class wrapper and add <code>.table</code> class to it to get something like this:</div>
                                 ...
                                 <div class="form-group col-sm-12">
                                                <label for="select2"><br> Selectionner  le ou les categories d'emplois auqueles vous-voulez postuler</label>
                                                <br>
                                                <select class="form-control select2" multiple="true" style="width: 200px;">
                                                    <option>Musique</option>
                                                    <option>Sport</option>
                                                    <option>Voyage</option>
                                                    <option>Lecture</option>
                                                    <option>Jeux</option>
                                                    <option>Nataion</option>
                                                    <option>danse</option>
                                                </select>
                                    </div>
                                        ...
                                        <table class="table table-bordered table-lg table-v2 table-striped">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td > 1 </td>
                                                    <td>John Mayers</td>
                                                    <td><img alt="" src="<?php echo base_url(); ?>img/flags-icons/us.png" width="25px"></td>
                                                    ...
                                                    <td class="row-actions">
                                                        ...
                                                        <a class="danger" href="#"><i class="os-icon os-icon-ui-15"></i></a></td>

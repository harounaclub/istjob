                ...
                <div class="content-i">
                    <div class="content-box">
                        <div class="element-wrapper">
                            <h6 class="element-header">Mes diplomes</h6>
                            <div class="element-box">
                                <h5 class="form-header">Mes diplomes</h5>
                                ...
                                <div class="form-buttons-w">
                                 <a href="<?php echo base_url(); ?>candidat/ajout_diplomes_direct" class="btn btn-primary" >Ajouter un diplome</a>
                                </div>
                                <br>
                                        ...
                                        <table class="table table-bordered table-lg table-v2 table-striped">
                                            ...
                                            <tbody>
                                               ...
                                               <tr>
                                                    ...
                                                    <td>
                                                         <a href="<?php echo base_url(); ?>candidat/supprim_diplome/<?php echo $id_diplome_candidat;?>" class="btn btn-danger"><div><i class="fa fa-twitter"></i></div>Supprimer</a>
                                                    </td>

                ...
                <div class="content-i">
                    <div class="content-box">
                        <div class="element-wrapper">
                            <h6 class="element-header">Etape 5/ 6 Hobbies</h6>
                            <div class="form-buttons-w">
                                 <a href="<?php echo base_url(); ?>candidat/redirige_langue" class="btn btn-primary" >Etape suivante</a>
                            </div>
                            <div class="element-box">
                                <h5 class="form-header">Etape 5/ 6 Hobbies</h5>
                                <div class="form-desc">
                                   
                                                Cette étape nous permet de recenser l'ensemble de vos hobbies et loisirs.<br>
                                                Pour ajouter un hobbie ou loisir cliquer sur le bouton "Ajouter un Hobbie ou loisir" puis remplir le formulaire <br> une fois terminée , cliquer sur Etape suivante<br>N.B: si vous n'avez aucune hobbie ou loisir ,cliquer directement sur Etape suivante </div>
                                                <a href="<?php echo base_url(); ?>candidat/ajout_loisire" class="btn btn-primary" >Ajouter un Hobbie ou loisir</a>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-lg table-v2 table-striped">
                                            ...
                                            <tbody>
                                               ...
                                               if(isset($liste_hobbie)){ 

                                               $compt=0;

                                                 foreach($liste_hobbie as $hobbie){
                                                 $id_loisir_candidat=$hobbie->id_loisir_candidat;
                                               ...
                                               <tr>
                                                    ...
                                                    <td ><?php echo $hobbie->loisir;  ?> </td>
                                                    <td ><?php echo $hobbie->commentaire;  ?> </td>
                                                    
                                                   
                                                    
                                                    <td>
                                                         <a href="<?php echo base_url(); ?>candidat/supprim_assistant_hobbies/<?php echo $id_loisir_candidat;?>" class="btn btn-danger"><div><i class="fa fa-twitter"></i></div>Supprimer</a>
                                                    </td>

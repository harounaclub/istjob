                ...
                <div class="content-i">
                    <div class="content-box">
                        <div class="element-wrapper">
                            <h6 class="element-header">Listes de mes offres</h6>
                            <div class="element-box">
                                <h5 class="form-header">Listes de mes offres</h5>
                                <div class="form-desc">Ce tableau présente la liste des offres d'emplois disponibles sur notre plateforme.</div>
                                        ...
                                        <table class="table table-bordered table-lg table-v2 table-striped">
                                            ...
                                            <tbody>
                                               ...
                                               $compt=0;
                                                 ...
                                                 foreach($liste_offres as $diplo){

                                               $compt=$compt+1;
                                               $id_offre=$diplo->id_offre;

                                               $id_entreprise=$diplo->id_entreprise;
                                               $entreprise=$this->candidat_model->getNom_entreprise($id_entreprise);

                                               ?>

                                               <tr>
                                                    <td ><?php echo $compt;  ?></td>
                                                    <td ><?php echo $diplo->intitule_offre ;  ?> </td>
                                                    

                                                    <td ><?php echo $diplo->duree_offre;  ?> </td>
                                                    <td ><?php echo $diplo->date_debut_offre;  ?> </td>
                                                    <td ><?php echo $diplo->date_fin_offre;  ?> </td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <?php
                                                               ...
                                                               $status_postulant=$this->candidat_model->verifie_si_candidat_offre($id_offre,$id_candidat);

                                                               if($status_postulant ==0){ ?>

                                                               <a href="<?php echo base_url(); ?>candidat/details_offre/<?php echo $id_offre; ?>" class="btn btn-primary"><div><i class="fa fa-twitter"></i></div>je postule</a>
                                                        ...
                                                        <?php
                                                               ...
                                                               if($status_postulant ==1){ ?>

                                                               <a href="<?php echo base_url(); ?>candidat/desouscrire/<?php echo $id_offre; ?>" class="btn btn-danger"><div><i class="fa fa-twitter"></i></div>se desinscrire</a>
                                                        ...
                                                        <?php
                                                               ...
                                                               if($status_postulant ==2){ ?>

                                                               <a href="#" class="btn btn-danger"><div><i class="fa fa-twitter"></i></div>Je ne veux plus postulé</a>

                    ...
                    <div class="content-box">
                        <div class="element-wrapper">
                            ...
                            <div class="element-box">
                                <h5 class="form-header">Information general</h5>
                            ...
                            <div class="col-sm-12">
                                <div class="element-wrapper">
                                    <div class="element-box">
                                        <span id="formValidate">
                                            <h5 class="form-header">Information general</h5>
                                            <div class="form-desc">Dans cette rubrique , nous allons collecter vos informations personnelles telles que nom,prenom(s) etc ...</div>
                                            ...
                                            <div class="element-wrapper">
                                                    ...
                                                    <div class="element-box">
                                                        ...
                                                        <form action="<?php echo base_url('candidat/updateUploadPhotoCandidat');?>" class="dropzone" id="my-awesome-dropzone" method="POST">
                                            ...
                                            if(isset($info_candidat)){
                                                foreach ($info_candidat as $val) { ?>
                                                    <div class="row">
                                            <div class="col-sm-6">
                                    <?php echo form_open('candidat/information_general'); ?>
                                            <div class="form-group">
                                                <label for=""> Nom</label>
                                                <input class="form-control"  type="text" name="nom" value="<?php echo $val->nom_candidat; ?>">
                                <?php echo form_error('nom','<font color="red">','</font>'); ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control"  type="text" name="prenom" value="<?php echo $val->prenoms_candidat;  ?>">
                                <?php echo form_error('prenom','<font color="red">','</font>'); ?>
                                            ...
                                            <div class="col-sm-6">
                                             <div class="form-group">
                                                ...
                                                <input class="form-control"  type="text" name="date_naissance"value="<?php echo $val->date_naissance;  ?>">
                                <?php echo form_error('date_naissance','<font color="red">','</font>'); ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control"  type="text "  name="lieu_naissance" value="<?php echo $val->lieu_naissance;  ?>">
                                <?php echo form_error('lieu_naissance','<font color="red">','</font>'); ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control"  type="text" name="email_candidat"  value="<?php echo $val->email_candidat;  ?>">
                                <?php echo form_error('email_candidat','<font color="red">','</font>'); ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" data-error="Your email address is invalid" placeholder="Entrer la Nationalite" required="required" type="text" name="nationnalite" value="<?php echo $val->nationnalite;  ?>">
                                    <?php echo form_error('nationnalite','<font color="red">','</font>'); ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control"  type="text" name="tel_mob_1"  value="<?php echo $val->telephone_mobil1;  ?>">
                                <?php echo form_error('tel_mob_1','<font color="red">','</font>'); ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="text" name="tel_mob_2" value="<?php echo $val->telephone_mobil2;  ?>">
                                <?php echo form_error('tel_mob_2','<font color="red">','</font>'); ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control"  type="text" name="tel_fix" value="<?php echo $val->telephone_fix;  ?>">
                                <?php echo form_error('tel_fix','<font color="red">','</font>'); ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" data-error="Your email address is invalid" placeholder="Entrer le nombre d'enfants" required="required" type="text" name="tel_fix">
                                    <?php echo form_error('tel_fix','<font color="red">','</font>'); ?>
                                                <div class="help-block form-text with-errors form-control-feedback"></div>
                                            </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="select_marital">
                                                    ...
                                                    $status_marital=$val->statut_marital;

                    ...
                    <div class="content-box">
                        <div class="element-wrapper">
                            ...
                            <div class="element-box">
                                ...
                                <div class="form-desc">Ce tableau présente la liste des offres d'emplois au quelles vous avez postulé.</div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-lg table-v2 table-striped">
                                            ...
                                            <tbody>
                                               ...
                                               if(isset($liste_offres_candidat)){ 

                                               

                                                 foreach($liste_offres_candidat as $offre){

                                               

                                               $id_offre=$offre->id_offre;
                                               $status=$offre->status;
                                               $info_offre=$this->candidat_model->getListe_offre_parID($id_offre);

                                               $compt=0;
                                                   foreach($info_offre as $item_offre){ 
                                                   $compt=$compt+1;
                                               ...
                                               <tr>
                                                    ...
                                                    <td ><?php echo $item_offre->intitule_offre;  ?> </td>
                                                    

                                                    <td ><?php echo $item_offre->duree_offre;  ?> </td>
                                                    <td ><?php echo $item_offre->date_debut_offre;  ?> </td>
                                                    <td ><?php echo $item_offre->date_fin_offre;  ?> </td>
                                                    ...
                                                    <td>
                                                         <?php
                                                               ...
                                                               <a href="#" class="btn btn-success"><div><i class="fa fa-twitter"></i></div>Déja postulé</a>
                                                        ...
                                                        <?php
                                                               ...
                                                               <a href="#" class="btn btn-danger"><div><i class="fa fa-twitter"></i></div>Souscription annulée</a>

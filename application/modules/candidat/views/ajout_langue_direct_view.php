...
<head>
    <title>ISTjob Ajouter langue</title>
    <meta charset="utf-8">
                    ...
                    <div class="content-box">
                        <div class="element-wrapper">
                            ...
                            <div class="element-box">
                                <h5 class="form-header">Ajouter langue</h5>
                                ...
                                <div class="element-wrapper">
                                    <div class="element-box">
                                        <span id="formValidate">
                                            <h5 class="form-header">Ajouter une langue</h5>
                                    ...
                                    <?php echo form_open('candidat/ajout_langues_directe'); ?>
                                                       <label for="">langue</label>
                                                        <input class="form-control" placeholder="Enter  votre langue" type="text" name="langue">
                                          <?php echo form_error('langue','<font color="red">','</font>'); ?>
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <div class="form-group" >
                                                        <select class="form-control" name="select_niveau">   
                                                            <option value="Débutant">Débutant</option>
                                                            <option value="Moyen">Moyen </option> 
                                                             <option value="Expert">Expert </option> 
                                                <?php echo form_error('select_niveau','<font color="red">','</font>'); ?>
                                                        </select>
                                                    </div>
                                                </div>

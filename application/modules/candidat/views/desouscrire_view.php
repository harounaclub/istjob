...
<head>
    <title>ISTjob Commentaire</title>
    <meta charset="utf-8">
                ...
                <div class="content-i">
                    <div class="content-box">
                        <div class="element-wrapper">
                            <h6 class="element-header">Desouscrire à cette offre</h6>
                            <div class="element-box">
                                <h5 class="form-header">Desouscrire à cette offre</h5>
...
------------------  -->
             ...
             <?php echo form_open('candidat/desouscrire_maintenant'); ?>
                    <div class="table-responsive">
                    <input type="text" name="id_offre" value="<?php echo $id_offre; ?>">
                    <label for="">Commentaire</label>
                            <label> </label>
                             <textarea class="form-control" id="localisation_entreprise" rows="6" name="commentaire"></textarea>
   ...
   <br>
                        <div class="form-buttons-w">
                                 ...
                                 <button type="submit" class="btn btn-primary">Desouscrire à cette offre</button>
                                </div>
                <?php echo form_close(); ?>

                                ...
                                <div class="element-wrapper">
                                    <div class="element-box">
                                        <span id="formValidate">
                                            ...
                                            <div class="form-desc">Remplisser correctement vos langues parlées ,lus et écris permet à nos recruteurs de mieux definir votre futur environnements de travail. </div>

                                            <div class="row">

                                                <div class="col-sm-6">
                                         <div class="form-group">
                                    <?php echo form_open('candidat/assistant_langue'); ?>

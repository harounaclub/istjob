...
<head>
    <title>ISTjob Ajouter experience profesionnelles</title>
    <meta charset="utf-8">
                    ...
                    <div class="content-box">
                        <div class="element-wrapper">
                            ...
                            <div class="element-box">
                                <h5 class="form-header">Ajouter une experience professionnelles</h5>
                                ...
                                <div class="element-wrapper">
                                    <div class="element-box">
                                        <span id="formValidate">
                                            <h5 class="form-header">Ajouter une experience professionnelles</h5>
                                            <div class="form-desc">Ce formulaire vous permet d'ajouter une de vos expériences professionnelles, n'hesiter surtout pas à nous donner plus de détails. </div>

 

                                            <div class="row">
                                     <div class="col-sm-6">
                                 <?php echo form_open('candidat/assistant_experiences_professionnelle'); ?>
                                    ...
                                    <?php echo form_error('poste_occupe','<font color="red">','</font>'); ?>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" rows="3" id="description_poste" name="description_poste">
                                        <?php echo form_error('description_poste','<font color="red">','</font>'); ?>
                                                    </textarea>
                                                </div>
                                        </div>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" rows="3" id="autre_desc" name="autre_desc">
                                        <?php echo form_error('autre_desc','<font color="red">','</font>'); ?>
                                                    </textarea>
                                                </div>
                                        </div>

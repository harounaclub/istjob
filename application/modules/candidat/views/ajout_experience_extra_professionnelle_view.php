...
<head>
    <title>ISTjob Ajouter experience extra_profesionnelles</title>
    <meta charset="utf-8">
                    ...
                    <div class="content-box">
                        <div class="element-wrapper">
                            ...
                            <div class="element-box">
                                <h5 class="form-header">Ajouter une experience extra professionnelles</h5>
                                ...
                                <div class="element-wrapper">
                                    <div class="element-box">
                                        <span id="formValidate">
                                            <h5 class="form-header">Ajouter une experience extra_professionnelles</h5>
                                            <div class="form-desc">Cher(e) candidat(e) ,prener soin de nous indiquer les dates debut et fin de votre expérience extra professionnelle et n'hesiter surtout de nous donner de plus ample détails dans la partie commentaire </div>

                                 

                                            <div class="row">
                                     <div class="col-sm-6">
                                    <?php echo form_open('candidat/assistant_extra_prof'); ?>
                                           <div class="form-group">
                                                            <label for=""> Date debut</label>
                                                            <div class="date-input">
                                                                <input class="single-daterange form-control" id="date_debut" placeholder="date debut"  type="text" name="date_debut">
                                    <?php echo form_error('date_debut','<font color="red">','</font>'); ?>
                                                            </div>
                                            </div>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                            ...
                                                            <div class="date-input">
                                                                <input class="single-daterange form-control" id="date_fin" placeholder="date fin"  type="text" name="date_fin">
                                    <?php echo form_error('date_fin','<font color="red">','</font>'); ?>
                                                            </div>
                                            </div>
                                        </div>
                                         ...
                                         <div class="col-lg-6">
                                            <div class="form-group">
                                              <label class="form-control-label">Entreprise ou organisation </label>
                                              <input class="form-control" type="text" name="entreprise" placeholder="Entreprise">
                                    <?php echo form_error('poste_occupe','<font color="red">','</font>'); ?>
                                            </div>
                                           ...
                                           <div class="col-lg-6">
                                            <div class="form-group">
                                              <label class="form-control-label"> Poste Occupé </label>
                                              <input class="form-control" type="text" name="poste_occupe" placeholder="poste Occupé">
                                    <?php echo form_error('poste_occupe','<font color="red">','</font>'); ?>
                                            </div>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" rows="3" id="commentaire" name="commentaire">
                                    <?php echo form_error('commentaire','<font color="red">','</font>'); ?>
                                                    </textarea>
                                                </div>
                                        </div>
                                        <div class="col-sm-12">

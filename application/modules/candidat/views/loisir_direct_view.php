                ...
                <div class="content-i">
                    <div class="content-box">
                        <div class="element-wrapper">
                            <h6 class="element-header">Mes Hobbies</h6>
                            
                            <div class="element-box">
                                <h5 class="form-header">Mes Hobbies</h5>
                                <div class="form-desc">
                                   
                                                Cet tableau  rétrace l'ensemble de vos  Hobbies .<br>
                                                Pour ajouter  Mes Hobbies  cliquer sur le bouton "Ajouter Mes Hobbies " puis remplir le formulaire <br> <br></div>
                                        ...
                                        <table class="table table-bordered table-lg table-v2 table-striped">
                                            ...
                                            <tbody>
                                               ...
                                               <tr>
                                                    ...
                                                    <td>
                                                         <a href="<?php echo base_url(); ?>candidat/supprim_hobbie/<?php echo $id_loisir_candidat;?>" class="btn btn-danger"><div><i class="fa fa-twitter"></i></div>Supprimer</a>
                                                    </td>

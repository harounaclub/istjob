...
<head>
    <title>Etape 4/ 6 Experiences Extra Professionnelles</title>
    <meta charset="utf-8">
                ...
                <div class="content-i">
                    <div class="content-box">
                        <div class="element-wrapper">
                            <h6 class="element-header">Experiences Extra Professionnelles</h6>
                            <div class="form-buttons-w">
                                 <a href="<?php echo base_url(); ?>candidat/redirige_hobbie" class="btn btn-primary" >Etape suivante</a>
                            </div>
                            <div class="element-box">
                                 <h5 class="form-header">Etape 4/ 6 Experience Extra professionnelle</h5>
                                 <div class="form-desc">
                                   
                                                Cette étape nous permet de recenser l'ensemble de vos expériences extra professionnelles.<br>
                                                Pour ajouter une expérience professionnelle cliquer sur le bouton "Ajouter une expérience extra professionnelle" puis remplir le formulaire <br> une fois terminée , cliquer sur Etape suivante<br>N.B: si vous n'avez aucune expérience professionnelle ,cliquer directement sur Etape suivante </div>
                                                <a href="<?php echo base_url(); ?>candidat/ajout_experience_extra_professionnelle" class="btn btn-primary" >Ajouter une extra experience professionnelle</a>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-lg table-v2 table-striped">
                                            ...
                                            <tbody>
                                               ...
                                               if(isset($liste_exp_extra_pro)){ 

                                               $compt=0;

                                                 foreach($liste_exp_extra_pro as $exp_exte_pro){
                                                 $id_experience_extra_pro_cand=$exp_exte_pro->id_experience_extra_pro_cand;
                                               ...
                                               <tr>
                                                    ...
                                                    <td ><?php echo $exp_exte_pro->date_debut_extra_experience;  ?> </td>
                                                    <td ><?php echo $exp_exte_pro->date_fin_extra_experience;  ?> </td>
                                                    <td ><?php echo $exp_exte_pro->commentaire;  ?> </td>
                                                   
                                                    
                                                    <td>
                                                         <a href="<?php echo base_url(); ?>candidat/supprim_assistant_expe_extr_pro/<?php echo $id_experience_extra_pro_cand;?>"  class="btn btn-danger"><div><i class="fa fa-twitter"></i></div>Supprimer</a>
                                                    </td>

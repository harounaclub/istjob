                ...
                <div class="content-i">
                    <div class="content-box">
                        <div class="element-wrapper">
                            <h6 class="element-header">Experiences Professionnelles </h6>
                            
                            <div class="element-box">
                                <h5 class="form-header"> Experiences Professionnelles</h5>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-lg table-v2 table-striped">
                                            ...
                                            <?php
                                               ...
                                               if(isset($liste_exp_pro)){ 

                                               $compt=0;

                                                 foreach($liste_exp_pro as $exp){
                                               ...
                                               <tr>
                                                    ...
                                                    <td>
                                                         <a href="<?php echo base_url(); ?>candidat/supprim_experience_pro/<?php echo $id_experience;?>" class="btn btn-danger"><div><i class="fa fa-twitter"></i></div>Supprimer</a>
                                                    </td>

...
<head>
    <title>ISTjob Ajouter diplome</title>
    <meta charset="utf-8">
                    ...
                    <div class="content-box">
                        <div class="element-wrapper">
                            ...
                            <div class="element-box">
                                <h5 class="form-header">Ajouter un diplome</h5>
                                ...
                                <div class="element-wrapper">
                                    <div class="element-box">
                                        <span id="formValidate">
                                            <h5 class="form-header">Ajouter un diplome </h5>
                                            <div class="form-desc">Ce formulaire vous permet d'ajouter un diplôme, remplisser soigneusement les informations date debut et dabut fin et n'hesiter pas à nous detailler vos expérience professionnelle dans la partie commentaire. </div>

                            
                                            <div class="row">
                                     <div class="col-sm-6">
                            <?php echo form_open('candidat/assistant_diplome'); ?>
                                           <div class="form-group">
                                                            <label for=""> Date debut</label>
                                                            <div class="date-input">
                                                                <input class="single-daterange form-control" id="date_debut" placeholder="date debut"  type="text" name="date_de_debut">
                            <?php echo form_error('date_de_debut','<font color="red">','</font>'); ?>
                                                            </div>
                                            </div>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                            ...
                                                            <div class="date-input">
                                                                <input class="single-daterange form-control" id="date_fin" placeholder="date fin"  type="text" name="date_de_fin">
                            <?php echo form_error('date_de_fin','<font color="red">','</font>'); ?>
                                                            </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                        ...
                                        <input class="form-control" placeholder="Enter  libelle diplome" type="text" name="lib_diplome">
                         <?php echo form_error('lib_diplome','<font color="red">','</font>'); ?>
                                        </div>
                                        </div>

                                         <div class="col-sm-6">
                                        <div class="form-group">
                                                <label for="">Donner le niveau équivalent de votre diplôme</label>
                                                <select class="form-control" name="niveau">

                                                     <option value="">Veuillez selectionné le niveau</option>

                                                    <?php

                                                   $liste_des_niveaux=$this->candidat_model->tous_niveau_offre();

                                                    if(isset($liste_des_niveaux)){


                                                        foreach ($liste_des_niveaux as $value) { ?>


                                                        <option value="<?php echo $value->libelle_niveaux_etude; ?>"><?php echo $value->libelle_niveaux_etude; ?></option>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" rows="3" id="commentaire" name="commentaires">
                            <?php echo form_error('commentaires','<font color="red">','</font>'); ?>
                                                    </textarea>
                                                </div>
                                        </div>
                                        <div class="col-sm-12">
                                           <button id="enr" class="btn btn-primary" type="submit"> ajouter</button>
                                        </div>
                            <?php echo form_close(); ?>
                                </div>

...
<head>
    <title>ISTjob experience_exra_professionnelle</title>
    <meta charset="utf-8">
                ...
                <div class="content-i">
                    <div class="content-box">
                        <div class="element-wrapper">
                            <h6 class="element-header">Experience extra_Professionnelles</h6>
                            
                            <div class="element-box">
                                <h5 class="form-header">Experience extra Professionnelles</h5>
                                 <div class="form-desc">
                                ...
                                <div class="form-buttons-w">
                                 <a href="<?php echo base_url(); ?>candidat/ajout_experience_extra_professionnelle_direct" class="btn btn-primary" >Ajouter</a>
                                </div>
                                <br>
                                        ...
                                        <table class="table table-bordered table-lg table-v2 table-striped">
                                            ...
                                            <tbody>
                                               ...
                                               <tr>
                                                    ...
                                                    <td>
                                                         <a href="<?php echo base_url(); ?>candidat/supprim_exp_extra_pro/<?php echo $id_experience_extra_pro_cand;?>"  class="btn btn-danger"><div><i class="fa fa-twitter"></i></div>Supprimer</a>
                                                    </td>

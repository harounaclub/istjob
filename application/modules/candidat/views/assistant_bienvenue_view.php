...
<head>
    <title>ISTjob Ajout experience profesionnelles</title>
    <meta charset="utf-8">
                                ...
                                <div class="element-wrapper">
                                    <div class="element-box">
                                        <form id="formValidate">
                                            <h5 class="form-header">Bienvenue sur votre espace candidat</h5>
                                            <div class="form-desc">
                                                Pour votre première connexion , notre assistant nous aidera à mieux vous connaitre afin de mieux cibler les recruteurs qui vous conviennent.<br>
                                                Cette assistant vous proposera des formulaires en 6 étapes afin de mieux adresser votre CV auprès de nos recruteurs.
                                                <br> Cliquer sur suivant en bas de page pour continuer. </div>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                     <a href="<?php echo base_url(); ?>candidat/assistant_information_generale" class="btn btn-primary" type="submit"> Suivant</a>
                                                </div>
                                            </div>

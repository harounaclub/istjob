                ...
                <div class="content-i">
                    <div class="content-box">
                        <div class="element-wrapper">
                            <h6 class="element-header">Mes langues</h6>
                            <div class="element-box">
                                <h5 class="form-header">Mes Langues</h5>
                                 <div class="form-desc">
                                ...
                                <div class="form-buttons-w">
                                 <a href="<?php echo base_url(); ?>candidat/ajout_langues" class="btn btn-primary" >Ajouter</a>
                                </div>
                                <br>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="row-actions">
                                                         <button class="mr-2 mb-2 btn btn-primary" data-target="#onboardingWideFeaturesModal" data-toggle="modal" type="button">plus info</button>
